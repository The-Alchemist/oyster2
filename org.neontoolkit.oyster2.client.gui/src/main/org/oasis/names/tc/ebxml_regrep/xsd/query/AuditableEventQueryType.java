...
/**
 *  AuditableEventQueryType bean class
 */
public class AuditableEventQueryType extends org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for AffectedObjectQuery
     * This was an Array!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType[] localAffectedObjectQuery;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localAffectedObjectQueryTracker = false;

    /**
     * field for EventTypeQuery
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.query.ClassificationNodeQueryType localEventTypeQuery;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localEventTypeQueryTracker = false;

    /**
     * field for UserQuery
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.query.UserQueryType localUserQuery;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localUserQueryTracker = false;
     ...
     * @return org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType[]
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType[] getAffectedObjectQuery() {
        return localAffectedObjectQuery;
    }

    /**
     * validate the array for AffectedObjectQuery
     */
    protected void validateAffectedObjectQuery(
        org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType[] param) {
    }

    /**
     * Auto generated setter method
     * @param param AffectedObjectQuery
     */
    public void setAffectedObjectQuery(
        org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType[] param) {
        validateAffectedObjectQuery(param);

        if (param != null) {
            //update the setting tracker
            localAffectedObjectQueryTracker = true;
        } else {
            localAffectedObjectQueryTracker = false;
        }

        this.localAffectedObjectQuery = param;
    }

    /**
     * Auto generated add method for the array for convenience
     * @param param org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType
     */
    public void addAffectedObjectQuery(
        org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType param) {
        if (localAffectedObjectQuery == null) {
            localAffectedObjectQuery = new org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType[] {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localAffectedObjectQuery);
        list.add(param);
        this.localAffectedObjectQuery = (org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType[]) list.toArray(new org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType[list.size()]);
    }
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.query.ClassificationNodeQueryType getEventTypeQuery() {
        return localEventTypeQuery;
    }

    /**
     * Auto generated setter method
     * @param param EventTypeQuery
     */
    public void setEventTypeQuery(
        org.oasis.names.tc.ebxml_regrep.xsd.query.ClassificationNodeQueryType param) {
        if (param != null) {
            //update the setting tracker
            localEventTypeQueryTracker = true;
        } else {
            localEventTypeQueryTracker = false;
        }

        this.localEventTypeQuery = param;
    }

    /**
     * Auto generated getter method
     * @return org.oasis.names.tc.ebxml_regrep.xsd.query.UserQueryType
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.query.UserQueryType getUserQuery() {
    ...
    public void setUserQuery(
        org.oasis.names.tc.ebxml_regrep.xsd.query.UserQueryType param) {
        if (param != null) {
            //update the setting tracker
            localUserQueryTracker = true;
        } else {
            localUserQueryTracker = false;
        }

        this.localUserQuery = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    AuditableEventQueryType.this.serialize(parentQName,
                        factory, xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":AuditableEventQueryType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "AuditableEventQueryType", xmlWriter);
        }
        ...
        if (localAffectedObjectQueryTracker) {
            if (localAffectedObjectQuery != null) {
                for (int i = 0; i < localAffectedObjectQuery.length; i++) {
                    if (localAffectedObjectQuery[i] != null) {
                        localAffectedObjectQuery[i].serialize(new javax.xml.namespace.QName(
                                "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                                "AffectedObjectQuery"), factory, xmlWriter);
                    } else {
                        // we don't have to do any thing since minOccures is zero
                    }
                }
                ...
                throw new org.apache.axis2.databinding.ADBException(
                    "AffectedObjectQuery cannot be null!!");
            }
        }

        if (localEventTypeQueryTracker) {
            if (localEventTypeQuery == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "EventTypeQuery cannot be null!!");
            }

            localEventTypeQuery.serialize(new javax.xml.namespace.QName(
                    "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                    "EventTypeQuery"), factory, xmlWriter);
        }

        if (localUserQueryTracker) {
            if (localUserQuery == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "UserQuery cannot be null!!");
            }

            localUserQuery.serialize(new javax.xml.namespace.QName(
                    "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0", "UserQuery"),
                factory, xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
                ...
                for (int i = 0; i < localAffectedObjectQuery.length; i++) {
                    if (localAffectedObjectQuery[i] != null) {
                        elementList.add(new javax.xml.namespace.QName(
                                "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                                "AffectedObjectQuery"));
                        elementList.add(localAffectedObjectQuery[i]);
                    } else {
                        // nothing to do
                    }
                }
        ...
        if (localEventTypeQueryTracker) {
            ...
            elementList.add(localEventTypeQuery);
        }
        ...
        if (localUserQueryTracker) {
            ...
            elementList.add(localUserQuery);
        }
    ...
    public static class Factory {
         ...
         */
        public static AuditableEventQueryType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AuditableEventQueryType object = new AuditableEventQueryType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AuditableEventQueryType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AuditableEventQueryType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                            "AffectedObjectQuery").equals(reader.getName())) {
                    // Process the array and step past its final element's end.
                    list12.add(org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType.Factory.parse(
                            reader));
                    ...
                    // call the converter utility  to convert and set the array
                    object.setAffectedObjectQuery((org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType.class,
                            list12));
                } // End of if for expected property start element
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                            "EventTypeQuery").equals(reader.getName())) {
                    object.setEventTypeQuery(org.oasis.names.tc.ebxml_regrep.xsd.query.ClassificationNodeQueryType.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                            "UserQuery").equals(reader.getName())) {
                    object.setUserQuery(org.oasis.names.tc.ebxml_regrep.xsd.query.UserQueryType.Factory.parse(
                            reader));
