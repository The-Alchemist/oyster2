...
public class OntologyLanguageQueryType extends org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType
     ...
     * This was an Array!
     */
    protected org.neontoolkit.registry.omv.xsd.query.KnowledgeRepresentationParadigmQueryType[] localSupportsRepresentationParadigmQuery;
     ...
     * This was an Array!
     */
    protected org.neontoolkit.registry.omv.xsd.query.OntologySyntaxQueryType[] localHasSyntaxQuery;
     ...
     */
    public org.neontoolkit.registry.omv.xsd.query.KnowledgeRepresentationParadigmQueryType[] getSupportsRepresentationParadigmQuery() {
    ...
    public void addSupportsRepresentationParadigmQuery(
        ...
        if (localSupportsRepresentationParadigmQuery == null) {
            localSupportsRepresentationParadigmQuery = new org.neontoolkit.registry.omv.xsd.query.KnowledgeRepresentationParadigmQueryType[] {
        ...
        list.add(param);
        this.localSupportsRepresentationParadigmQuery = (org.neontoolkit.registry.omv.xsd.query.KnowledgeRepresentationParadigmQueryType[]) list.toArray(new org.neontoolkit.registry.omv.xsd.query.KnowledgeRepresentationParadigmQueryType[list.size()]);
    }
     ...
     */
    public org.neontoolkit.registry.omv.xsd.query.OntologySyntaxQueryType[] getHasSyntaxQuery() {
    ...
    public void addHasSyntaxQuery(
        ...
        if (localHasSyntaxQuery == null) {
            localHasSyntaxQuery = new org.neontoolkit.registry.omv.xsd.query.OntologySyntaxQueryType[] {
        ...
        list.add(param);
        this.localHasSyntaxQuery = (org.neontoolkit.registry.omv.xsd.query.OntologySyntaxQueryType[]) list.toArray(new org.neontoolkit.registry.omv.xsd.query.OntologySyntaxQueryType[list.size()]);
    }
            ...
            try {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            ...
                            reader.getName())) {
                    // Process the array and step past its final element's end.
                    list16.add(org.neontoolkit.registry.omv.xsd.query.KnowledgeRepresentationParadigmQueryType.Factory.parse(
                            reader));
                    ...
                    // call the converter utility  to convert and set the array
                    object.setSupportsRepresentationParadigmQuery((org.neontoolkit.registry.omv.xsd.query.KnowledgeRepresentationParadigmQueryType[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                ...
                if (reader.isStartElement() &&
                    ...
                    // Process the array and step past its final element's end.
                    list17.add(org.neontoolkit.registry.omv.xsd.query.OntologySyntaxQueryType.Factory.parse(
                            reader));
                    ...
                    // call the converter utility  to convert and set the array
                    object.setHasSyntaxQuery((org.neontoolkit.registry.omv.xsd.query.OntologySyntaxQueryType[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
