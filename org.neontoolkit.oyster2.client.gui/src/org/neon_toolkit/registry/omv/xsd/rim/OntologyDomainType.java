...
/**
 *  OntologyDomainType bean class
 */
public class OntologyDomainType extends org.neon_toolkit.registry.omv.xsd.rim.OMVRegistryObjectType
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for IsSubDomainOf
     * This was an Array!
     */
    protected org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[] localIsSubDomainOf;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localIsSubDomainOfTracker = false;
     ...
     */
    public org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[] getIsSubDomainOf() {
        return localIsSubDomainOf;
    }

    /**
     * validate the array for IsSubDomainOf
     */
    protected void validateIsSubDomainOf(
        org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[] param) {
    }

    /**
     * Auto generated setter method
     * @param param IsSubDomainOf
     */
    public void setIsSubDomainOf(
        org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[] param) {
        validateIsSubDomainOf(param);

        if (param != null) {
            //update the setting tracker
            localIsSubDomainOfTracker = true;
        } else {
            localIsSubDomainOfTracker = false;
        }

        this.localIsSubDomainOf = param;
    }
     ...
     */
    public void addIsSubDomainOf(
        org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType param) {
        if (localIsSubDomainOf == null) {
            localIsSubDomainOf = new org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[] {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localIsSubDomainOf);
        list.add(param);
        this.localIsSubDomainOf = (org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[]) list.toArray(new org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[list.size()]);
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    OntologyDomainType.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":OntologyDomainType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "OntologyDomainType", xmlWriter);
        }
        ...
        if (localIsSubDomainOfTracker) {
            if (localIsSubDomainOf != null) {
                for (int i = 0; i < localIsSubDomainOf.length; i++) {
                    if (localIsSubDomainOf[i] != null) {
                        localIsSubDomainOf[i].serialize(new javax.xml.namespace.QName(
                                "urn:neon-toolkit-org:registry:omv:xsd:rim:2.3",
                                "isSubDomainOf"), factory, xmlWriter);
                    } else {
                        // we don't have to do any thing since minOccures is zero
                    }
                }
                ...
                for (int i = 0; i < localIsSubDomainOf.length; i++) {
                    if (localIsSubDomainOf[i] != null) {
                        elementList.add(new javax.xml.namespace.QName(
                                "urn:neon-toolkit-org:registry:omv:xsd:rim:2.3",
                                "isSubDomainOf"));
                        elementList.add(localIsSubDomainOf[i]);
                    } else {
                        // nothing to do
                    }
                }
    ...
    public static class Factory {
         ...
         */
        public static OntologyDomainType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            OntologyDomainType object = new OntologyDomainType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"OntologyDomainType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (OntologyDomainType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:neon-toolkit-org:registry:omv:xsd:rim:2.3",
                            "isSubDomainOf").equals(reader.getName())) {
                    // Process the array and step past its final element's end.
                    ...
                    // call the converter utility  to convert and set the array
                    object.setIsSubDomainOf((org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
