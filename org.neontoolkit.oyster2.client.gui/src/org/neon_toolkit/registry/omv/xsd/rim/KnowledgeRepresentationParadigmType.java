/**
 * KnowledgeRepresentationParadigmType.java
 *
...
/**
 *  KnowledgeRepresentationParadigmType bean class
 */
public class KnowledgeRepresentationParadigmType extends org.neon_toolkit.registry.omv.xsd.rim.OMVRegistryObjectType
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for SpecifiedBy
     * This was an Array!
     */
    protected org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[] localSpecifiedBy;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localSpecifiedByTracker = false;

    /* This type was generated from the piece of schema that had
       name = KnowledgeRepresentationParadigmType
     ...
     */
    public org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[] getSpecifiedBy() {
        return localSpecifiedBy;
    }

    /**
     * validate the array for SpecifiedBy
     */
    protected void validateSpecifiedBy(
        org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[] param) {
    }

    /**
     * Auto generated setter method
     * @param param SpecifiedBy
     */
    public void setSpecifiedBy(
        org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[] param) {
        validateSpecifiedBy(param);

        if (param != null) {
            //update the setting tracker
            localSpecifiedByTracker = true;
        } else {
            localSpecifiedByTracker = false;
        }

        this.localSpecifiedBy = param;
    }
     ...
     */
    public void addSpecifiedBy(
        org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType param) {
        if (localSpecifiedBy == null) {
            localSpecifiedBy = new org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[] {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localSpecifiedBy);
        list.add(param);
        this.localSpecifiedBy = (org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[]) list.toArray(new org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[list.size()]);
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    KnowledgeRepresentationParadigmType.this.serialize(parentQName,
                        factory, xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type",
                namespacePrefix + ":KnowledgeRepresentationParadigmType",
                xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "KnowledgeRepresentationParadigmType", xmlWriter);
        }
        ...
        if (localSpecifiedByTracker) {
            if (localSpecifiedBy != null) {
                for (int i = 0; i < localSpecifiedBy.length; i++) {
                    if (localSpecifiedBy[i] != null) {
                        localSpecifiedBy[i].serialize(new javax.xml.namespace.QName(
                                "urn:neon-toolkit-org:registry:omv:xsd:rim:2.3",
                                "specifiedBy"), factory, xmlWriter);
                    } else {
                        // we don't have to do any thing since minOccures is zero
                    }
                }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        attribList.add(new javax.xml.namespace.QName(
                "urn:neon-toolkit-org:registry:omv:xsd:rim:2.3",
                "KnowledgeRepresentationParadigmType"));
                ...
                for (int i = 0; i < localSpecifiedBy.length; i++) {
                    if (localSpecifiedBy[i] != null) {
                        elementList.add(new javax.xml.namespace.QName(
                                "urn:neon-toolkit-org:registry:omv:xsd:rim:2.3",
                                "specifiedBy"));
                        elementList.add(localSpecifiedBy[i]);
                    } else {
                        // nothing to do
                    }
                }
    ...
    public static class Factory {
         ...
         */
        public static KnowledgeRepresentationParadigmType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            KnowledgeRepresentationParadigmType object = new KnowledgeRepresentationParadigmType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"KnowledgeRepresentationParadigmType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (KnowledgeRepresentationParadigmType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:neon-toolkit-org:registry:omv:xsd:rim:2.3",
                            "specifiedBy").equals(reader.getName())) {
                    // Process the array and step past its final element's end.
                    ...
                    // call the converter utility  to convert and set the array
                    object.setSpecifiedBy((org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
