...
/**
 *  AdhocQueryQueryType bean class
 */
public class AdhocQueryQueryType extends org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for QueryExpressionBranch
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.query.QueryExpressionBranchType localQueryExpressionBranch;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localQueryExpressionBranchTracker = false;
     ...
     * @return org.oasis.names.tc.ebxml_regrep.xsd.query.QueryExpressionBranchType
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.query.QueryExpressionBranchType getQueryExpressionBranch() {
        return localQueryExpressionBranch;
    }

    /**
     * Auto generated setter method
     * @param param QueryExpressionBranch
     */
    public void setQueryExpressionBranch(
        org.oasis.names.tc.ebxml_regrep.xsd.query.QueryExpressionBranchType param) {
        if (param != null) {
            //update the setting tracker
            localQueryExpressionBranchTracker = true;
        } else {
            localQueryExpressionBranchTracker = false;
        }

        this.localQueryExpressionBranch = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    AdhocQueryQueryType.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":AdhocQueryQueryType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "AdhocQueryQueryType", xmlWriter);
        }
        ...
        if (localQueryExpressionBranchTracker) {
            if (localQueryExpressionBranch == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "QueryExpressionBranch cannot be null!!");
            }

            localQueryExpressionBranch.serialize(new javax.xml.namespace.QName(
                    "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                    "QueryExpressionBranch"), factory, xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localQueryExpressionBranchTracker) {
            ...
            elementList.add(localQueryExpressionBranch);
        }
    ...
    public static class Factory {
         ...
         */
        public static AdhocQueryQueryType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AdhocQueryQueryType object = new AdhocQueryQueryType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AdhocQueryQueryType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AdhocQueryQueryType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                            "QueryExpressionBranch").equals(reader.getName())) {
                    object.setQueryExpressionBranch(org.oasis.names.tc.ebxml_regrep.xsd.query.QueryExpressionBranchType.Factory.parse(
                            reader));
