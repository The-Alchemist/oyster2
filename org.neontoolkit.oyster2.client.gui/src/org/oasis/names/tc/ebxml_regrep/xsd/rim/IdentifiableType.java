...
/**
 *  IdentifiableType bean class
 */
public class IdentifiableType implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for Slot
     * This was an Array!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.SlotType1[] localSlot;
     ...
     * This was an Attribute!
     */
    protected org.apache.axis2.databinding.types.URI localHome;
     ...
     * @return org.oasis.names.tc.ebxml_regrep.xsd.rim.SlotType1[]
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.SlotType1[] getSlot() {
        return localSlot;
    }
    ...
    protected void validateSlot(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.SlotType1[] param) {
    }
     ...
     * @param param org.oasis.names.tc.ebxml_regrep.xsd.rim.SlotType1
     */
    public void addSlot(org.oasis.names.tc.ebxml_regrep.xsd.rim.SlotType1 param) {
        if (localSlot == null) {
            localSlot = new org.oasis.names.tc.ebxml_regrep.xsd.rim.SlotType1[] {  };
        }

        //update the setting tracker
        localSlotTracker = true;

        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localSlot);
        list.add(param);
        this.localSlot = (org.oasis.names.tc.ebxml_regrep.xsd.rim.SlotType1[]) list.toArray(new org.oasis.names.tc.ebxml_regrep.xsd.rim.SlotType1[list.size()]);
    }
     ...
     * @return org.apache.axis2.databinding.types.URI
     */
    public org.apache.axis2.databinding.types.URI getHome() {
        return localHome;
    }
     ...
     * @param param Home
     */
    public void setHome(org.apache.axis2.databinding.types.URI param) {
        this.localHome = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    IdentifiableType.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public static class Factory {
         ...
         */
        public static IdentifiableType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            IdentifiableType object = new IdentifiableType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"IdentifiableType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (IdentifiableType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
