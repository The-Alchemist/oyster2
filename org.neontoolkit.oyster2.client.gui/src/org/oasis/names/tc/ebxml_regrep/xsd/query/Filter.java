 ...
 *  Filter bean class
 */
public class Filter implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Filter
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.query.FilterType localFilter;
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.query.FilterType getFilter() {
        return localFilter;
    }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                            ...
                            object.setFilter(org.oasis.names.tc.ebxml_regrep.xsd.query.FilterType.Factory.parse(
                                    reader));
