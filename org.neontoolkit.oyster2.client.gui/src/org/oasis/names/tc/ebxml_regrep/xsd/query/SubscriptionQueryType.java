...
/**
 *  SubscriptionQueryType bean class
 */
public class SubscriptionQueryType extends org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for SelectorQuery
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.query.AdhocQueryQueryType localSelectorQuery;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localSelectorQueryTracker = false;
     ...
     * @return org.oasis.names.tc.ebxml_regrep.xsd.query.AdhocQueryQueryType
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.query.AdhocQueryQueryType getSelectorQuery() {
        return localSelectorQuery;
    }

    /**
     * Auto generated setter method
     * @param param SelectorQuery
     */
    public void setSelectorQuery(
        org.oasis.names.tc.ebxml_regrep.xsd.query.AdhocQueryQueryType param) {
        if (param != null) {
            //update the setting tracker
            localSelectorQueryTracker = true;
        } else {
            localSelectorQueryTracker = false;
        }

        this.localSelectorQuery = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    SubscriptionQueryType.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":SubscriptionQueryType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "SubscriptionQueryType", xmlWriter);
        }
        ...
        if (localSelectorQueryTracker) {
            if (localSelectorQuery == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "SelectorQuery cannot be null!!");
            }

            localSelectorQuery.serialize(new javax.xml.namespace.QName(
                    "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                    "SelectorQuery"), factory, xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localSelectorQueryTracker) {
            ...
            elementList.add(localSelectorQuery);
        }
    ...
    public static class Factory {
         ...
         */
        public static SubscriptionQueryType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SubscriptionQueryType object = new SubscriptionQueryType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SubscriptionQueryType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SubscriptionQueryType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                            "SelectorQuery").equals(reader.getName())) {
                    object.setSelectorQuery(org.oasis.names.tc.ebxml_regrep.xsd.query.AdhocQueryQueryType.Factory.parse(
                            reader));
