...
public class FilterType implements org.apache.axis2.databinding.ADBBean {
     ...
     * @param param Negate
     */
    public void setNegate(boolean param) {
        this.localNegate = param;
    }
    ...
    public static class Factory {
         ...
         */
        public static FilterType parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"FilterType".equals(type)) {
                            ...
                            return (FilterType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
