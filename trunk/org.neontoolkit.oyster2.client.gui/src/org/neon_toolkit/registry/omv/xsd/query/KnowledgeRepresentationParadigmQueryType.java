/**
 * KnowledgeRepresentationParadigmQueryType.java
 *
...
/**
 *  KnowledgeRepresentationParadigmQueryType bean class
 */
public class KnowledgeRepresentationParadigmQueryType extends org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType
    ...
    /**
     * field for SpecifiedByOrganizationQuery
     * This was an Array!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.query.OrganizationQueryType[] localSpecifiedByOrganizationQuery;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localSpecifiedByOrganizationQueryTracker = false;

    /**
     * field for SpecifiedByPersonQuery
     * This was an Array!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.query.PersonQueryType[] localSpecifiedByPersonQuery;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localSpecifiedByPersonQueryTracker = false;

    /* This type was generated from the piece of schema that had
       name = KnowledgeRepresentationParadigmQueryType
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.query.OrganizationQueryType[] getSpecifiedByOrganizationQuery() {
        return localSpecifiedByOrganizationQuery;
    }

    /**
     * validate the array for SpecifiedByOrganizationQuery
     */
    protected void validateSpecifiedByOrganizationQuery(
        org.oasis.names.tc.ebxml_regrep.xsd.query.OrganizationQueryType[] param) {
    }

    /**
     * Auto generated setter method
     * @param param SpecifiedByOrganizationQuery
     */
    public void setSpecifiedByOrganizationQuery(
        org.oasis.names.tc.ebxml_regrep.xsd.query.OrganizationQueryType[] param) {
        validateSpecifiedByOrganizationQuery(param);

        if (param != null) {
            //update the setting tracker
            localSpecifiedByOrganizationQueryTracker = true;
        } else {
            localSpecifiedByOrganizationQueryTracker = false;
        }

        this.localSpecifiedByOrganizationQuery = param;
    }
     ...
     */
    public void addSpecifiedByOrganizationQuery(
        org.oasis.names.tc.ebxml_regrep.xsd.query.OrganizationQueryType param) {
        if (localSpecifiedByOrganizationQuery == null) {
            localSpecifiedByOrganizationQuery = new org.oasis.names.tc.ebxml_regrep.xsd.query.OrganizationQueryType[] {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localSpecifiedByOrganizationQuery);
        list.add(param);
        this.localSpecifiedByOrganizationQuery = (org.oasis.names.tc.ebxml_regrep.xsd.query.OrganizationQueryType[]) list.toArray(new org.oasis.names.tc.ebxml_regrep.xsd.query.OrganizationQueryType[list.size()]);
    }
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.query.PersonQueryType[] getSpecifiedByPersonQuery() {
        return localSpecifiedByPersonQuery;
    }

    /**
     * validate the array for SpecifiedByPersonQuery
     */
    protected void validateSpecifiedByPersonQuery(
        org.oasis.names.tc.ebxml_regrep.xsd.query.PersonQueryType[] param) {
    }

    /**
     * Auto generated setter method
     * @param param SpecifiedByPersonQuery
     */
    public void setSpecifiedByPersonQuery(
        org.oasis.names.tc.ebxml_regrep.xsd.query.PersonQueryType[] param) {
        validateSpecifiedByPersonQuery(param);

        if (param != null) {
            //update the setting tracker
            localSpecifiedByPersonQueryTracker = true;
        } else {
            localSpecifiedByPersonQueryTracker = false;
        }

        this.localSpecifiedByPersonQuery = param;
    }
     ...
     */
    public void addSpecifiedByPersonQuery(
        org.oasis.names.tc.ebxml_regrep.xsd.query.PersonQueryType param) {
        if (localSpecifiedByPersonQuery == null) {
            localSpecifiedByPersonQuery = new org.oasis.names.tc.ebxml_regrep.xsd.query.PersonQueryType[] {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localSpecifiedByPersonQuery);
        list.add(param);
        this.localSpecifiedByPersonQuery = (org.oasis.names.tc.ebxml_regrep.xsd.query.PersonQueryType[]) list.toArray(new org.oasis.names.tc.ebxml_regrep.xsd.query.PersonQueryType[list.size()]);
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    KnowledgeRepresentationParadigmQueryType.this.serialize(parentQName,
                        factory, xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type",
                namespacePrefix + ":KnowledgeRepresentationParadigmQueryType",
                xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "KnowledgeRepresentationParadigmQueryType", xmlWriter);
        }
        ...
        if (localSpecifiedByOrganizationQueryTracker) {
            if (localSpecifiedByOrganizationQuery != null) {
                for (int i = 0; i < localSpecifiedByOrganizationQuery.length;
                        i++) {
                    if (localSpecifiedByOrganizationQuery[i] != null) {
                        localSpecifiedByOrganizationQuery[i].serialize(new javax.xml.namespace.QName(
                                "urn:neon-toolkit-org:registry:omv:xsd:query:2.3",
                                "SpecifiedByOrganizationQuery"), factory,
                            xmlWriter);
                    } else {
                        // we don't have to do any thing since minOccures is zero
                    }
                ...
                throw new org.apache.axis2.databinding.ADBException(
                    "SpecifiedByOrganizationQuery cannot be null!!");
            }
        }

        if (localSpecifiedByPersonQueryTracker) {
            if (localSpecifiedByPersonQuery != null) {
                for (int i = 0; i < localSpecifiedByPersonQuery.length; i++) {
                    if (localSpecifiedByPersonQuery[i] != null) {
                        localSpecifiedByPersonQuery[i].serialize(new javax.xml.namespace.QName(
                                "urn:neon-toolkit-org:registry:omv:xsd:query:2.3",
                                "SpecifiedByPersonQuery"), factory, xmlWriter);
                    } else {
                        // we don't have to do any thing since minOccures is zero
                    }
                }
                ...
                throw new org.apache.axis2.databinding.ADBException(
                    "SpecifiedByPersonQuery cannot be null!!");
            }
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        attribList.add(new javax.xml.namespace.QName(
                "urn:neon-toolkit-org:registry:omv:xsd:query:2.3",
                "KnowledgeRepresentationParadigmQueryType"));
            ...
            if (localSpecifiedByOrganizationQuery != null) {
                for (int i = 0; i < localSpecifiedByOrganizationQuery.length;
                    ...
                    if (localSpecifiedByOrganizationQuery[i] != null) {
                        elementList.add(new javax.xml.namespace.QName(
                                "urn:neon-toolkit-org:registry:omv:xsd:query:2.3",
                                "SpecifiedByOrganizationQuery"));
                        elementList.add(localSpecifiedByOrganizationQuery[i]);
                    } else {
                        // nothing to do
                    }
                }
            ...
            if (localSpecifiedByPersonQuery != null) {
                for (int i = 0; i < localSpecifiedByPersonQuery.length; i++) {
                    if (localSpecifiedByPersonQuery[i] != null) {
                        elementList.add(new javax.xml.namespace.QName(
                                "urn:neon-toolkit-org:registry:omv:xsd:query:2.3",
                                "SpecifiedByPersonQuery"));
                        elementList.add(localSpecifiedByPersonQuery[i]);
                    } else {
                        // nothing to do
                    }
                }
    ...
    public static class Factory {
         ...
         */
        public static KnowledgeRepresentationParadigmQueryType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            KnowledgeRepresentationParadigmQueryType object = new KnowledgeRepresentationParadigmQueryType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"KnowledgeRepresentationParadigmQueryType".equals(
                                    type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (KnowledgeRepresentationParadigmQueryType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:neon-toolkit-org:registry:omv:xsd:query:2.3",
                            "SpecifiedByOrganizationQuery").equals(
                            reader.getName())) {
                    // Process the array and step past its final element's end.
                    ...
                    // call the converter utility  to convert and set the array
                    object.setSpecifiedByOrganizationQuery((org.oasis.names.tc.ebxml_regrep.xsd.query.OrganizationQueryType[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:neon-toolkit-org:registry:omv:xsd:query:2.3",
                            "SpecifiedByPersonQuery").equals(reader.getName())) {
                    // Process the array and step past its final element's end.
                    ...
                    // call the converter utility  to convert and set the array
                    object.setSpecifiedByPersonQuery((org.oasis.names.tc.ebxml_regrep.xsd.query.PersonQueryType[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
