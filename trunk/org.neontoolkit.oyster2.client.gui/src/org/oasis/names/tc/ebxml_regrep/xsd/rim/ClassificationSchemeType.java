...
/**
 *  ClassificationSchemeType bean class
 */
public class ClassificationSchemeType extends org.oasis.names.tc.ebxml_regrep.xsd.rim.RegistryObjectType
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for ClassificationNode
     * This was an Array!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ClassificationNodeType[] localClassificationNode;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localClassificationNodeTracker = false;

    /**
     * field for IsInternal
     * This was an Attribute!
     */
    protected boolean localIsInternal;

    /**
     * field for NodeType
     * This was an Attribute!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI localNodeType;
     ...
     * @return org.oasis.names.tc.ebxml_regrep.xsd.rim.ClassificationNodeType[]
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ClassificationNodeType[] getClassificationNode() {
        return localClassificationNode;
    }

    /**
     * validate the array for ClassificationNode
     */
    protected void validateClassificationNode(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.ClassificationNodeType[] param) {
    }
    ...
    public void setClassificationNode(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.ClassificationNodeType[] param) {
        validateClassificationNode(param);

        if (param != null) {
            //update the setting tracker
            localClassificationNodeTracker = true;
        } else {
            localClassificationNodeTracker = false;
        }
     ...
     * @param param org.oasis.names.tc.ebxml_regrep.xsd.rim.ClassificationNodeType
     */
    public void addClassificationNode(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.ClassificationNodeType param) {
        if (localClassificationNode == null) {
            localClassificationNode = new org.oasis.names.tc.ebxml_regrep.xsd.rim.ClassificationNodeType[] {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localClassificationNode);
        list.add(param);
        this.localClassificationNode = (org.oasis.names.tc.ebxml_regrep.xsd.rim.ClassificationNodeType[]) list.toArray(new org.oasis.names.tc.ebxml_regrep.xsd.rim.ClassificationNodeType[list.size()]);
    }
     ...
     */
    public void setIsInternal(boolean param) {
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI getNodeType() {
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    ClassificationSchemeType.this.serialize(parentQName,
                        factory, xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":ClassificationSchemeType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "ClassificationSchemeType", xmlWriter);
        }
        ...
        if (true) {
            writeAttribute("", "isInternal",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localIsInternal), xmlWriter);
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "required attribute localIsInternal is null");
        }

        if (localNodeType != null) {
            writeAttribute("", "nodeType", localNodeType.toString(), xmlWriter);
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "required attribute localNodeType is null");
        }
        ...
        if (localClassificationNodeTracker) {
            if (localClassificationNode != null) {
                for (int i = 0; i < localClassificationNode.length; i++) {
                    if (localClassificationNode[i] != null) {
                        localClassificationNode[i].serialize(new javax.xml.namespace.QName(
                                "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0",
                                "ClassificationNode"), factory, xmlWriter);
                    } else {
                        // we don't have to do any thing since minOccures is zero
                    }
                }
                ...
                throw new org.apache.axis2.databinding.ADBException(
                    "ClassificationNode cannot be null!!");
            }
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
                ...
                for (int i = 0; i < localClassificationNode.length; i++) {
                    if (localClassificationNode[i] != null) {
                        elementList.add(new javax.xml.namespace.QName(
                                "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0",
                                "ClassificationNode"));
                        elementList.add(localClassificationNode[i]);
                    } else {
                        // nothing to do
                    }
                }
        ...
        attribList.add(new javax.xml.namespace.QName("", "isInternal"));

        attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                localIsInternal));

        attribList.add(new javax.xml.namespace.QName("", "nodeType"));

        attribList.add(localNodeType.toString());
    ...
    public static class Factory {
         ...
         */
        public static ClassificationSchemeType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ClassificationSchemeType object = new ClassificationSchemeType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ClassificationSchemeType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ClassificationSchemeType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                // handle attribute "isInternal"
                java.lang.String tempAttribIsInternal = reader.getAttributeValue(null,
                        "isInternal");

                if (tempAttribIsInternal != null) {
                    java.lang.String content = tempAttribIsInternal;

                    object.setIsInternal(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
                            tempAttribIsInternal));
                } else {
                    throw new org.apache.axis2.databinding.ADBException(
                        "Required attribute isInternal is missing");
                }

                handledAttributes.add("isInternal");

                // handle attribute "nodeType"
                java.lang.String tempAttribNodeType = reader.getAttributeValue(null,
                        "nodeType");

                if (tempAttribNodeType != null) {
                    java.lang.String content = tempAttribNodeType;

                    if (tempAttribNodeType.indexOf(":") > 0) {
                        // this seems to be a Qname so find the namespace and send
                        prefix = tempAttribNodeType.substring(0,
                                tempAttribNodeType.indexOf(":"));
                        namespaceuri = reader.getNamespaceURI(prefix);
                        object.setNodeType(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribNodeType, namespaceuri));
                    } else {
                        // this seems to be not a qname send and empty namespace incase of it is
                        // check is done in fromString method
                        object.setNodeType(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                    ...
                    throw new org.apache.axis2.databinding.ADBException(
                        "Required attribute nodeType is missing");
                }

                handledAttributes.add("nodeType");
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0",
                            "ClassificationNode").equals(reader.getName())) {
                    // Process the array and step past its final element's end.
                    list7.add(org.oasis.names.tc.ebxml_regrep.xsd.rim.ClassificationNodeType.Factory.parse(
                            reader));
                    ...
                    // call the converter utility  to convert and set the array
                    object.setClassificationNode((org.oasis.names.tc.ebxml_regrep.xsd.rim.ClassificationNodeType[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            org.oasis.names.tc.ebxml_regrep.xsd.rim.ClassificationNodeType.class,
                            list7));
                } // End of if for expected property start element
