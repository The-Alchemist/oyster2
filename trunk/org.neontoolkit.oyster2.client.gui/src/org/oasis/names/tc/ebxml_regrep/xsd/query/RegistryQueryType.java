...
/**
 *  RegistryQueryType bean class
 */
public class RegistryQueryType extends org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for OperatorQuery
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.query.OrganizationQueryType localOperatorQuery;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localOperatorQueryTracker = false;
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.query.OrganizationQueryType getOperatorQuery() {
        return localOperatorQuery;
    }

    /**
     * Auto generated setter method
     * @param param OperatorQuery
     */
    public void setOperatorQuery(
        org.oasis.names.tc.ebxml_regrep.xsd.query.OrganizationQueryType param) {
        if (param != null) {
            //update the setting tracker
            localOperatorQueryTracker = true;
        } else {
            localOperatorQueryTracker = false;
        }

        this.localOperatorQuery = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    RegistryQueryType.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":RegistryQueryType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "RegistryQueryType", xmlWriter);
        }
        ...
        if (localOperatorQueryTracker) {
            if (localOperatorQuery == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "OperatorQuery cannot be null!!");
            }

            localOperatorQuery.serialize(new javax.xml.namespace.QName(
                    "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                    "OperatorQuery"), factory, xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localOperatorQueryTracker) {
            ...
            elementList.add(localOperatorQuery);
        }
    ...
    public static class Factory {
         ...
         */
        public static RegistryQueryType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RegistryQueryType object = new RegistryQueryType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RegistryQueryType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RegistryQueryType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                            "OperatorQuery").equals(reader.getName())) {
                    object.setOperatorQuery(org.oasis.names.tc.ebxml_regrep.xsd.query.OrganizationQueryType.Factory.parse(
                            reader));
