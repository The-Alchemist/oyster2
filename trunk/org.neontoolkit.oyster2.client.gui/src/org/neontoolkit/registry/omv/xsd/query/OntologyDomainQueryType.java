...
public class OntologyDomainQueryType extends org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType
     ...
     * This was an Array!
     */
    protected org.neontoolkit.registry.omv.xsd.query.OntologyDomainQueryType[] localIsSubDomainOfQuery;
     ...
     */
    public org.neontoolkit.registry.omv.xsd.query.OntologyDomainQueryType[] getIsSubDomainOfQuery() {
    ...
    public void addIsSubDomainOfQuery(
        ...
        if (localIsSubDomainOfQuery == null) {
            localIsSubDomainOfQuery = new org.neontoolkit.registry.omv.xsd.query.OntologyDomainQueryType[] {
        ...
        list.add(param);
        this.localIsSubDomainOfQuery = (org.neontoolkit.registry.omv.xsd.query.OntologyDomainQueryType[]) list.toArray(new org.neontoolkit.registry.omv.xsd.query.OntologyDomainQueryType[list.size()]);
    }
        ...
        public static OntologyDomainQueryType parse(
            ...
            try {
                ...
                if (reader.isStartElement() &&
                    ...
                    // Process the array and step past its final element's end.
                    list13.add(org.neontoolkit.registry.omv.xsd.query.OntologyDomainQueryType.Factory.parse(
                            reader));
                    ...
                    // call the converter utility  to convert and set the array
                    object.setIsSubDomainOfQuery((org.neontoolkit.registry.omv.xsd.query.OntologyDomainQueryType[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
