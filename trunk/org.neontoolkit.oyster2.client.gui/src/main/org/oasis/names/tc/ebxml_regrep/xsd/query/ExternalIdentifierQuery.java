...
/**
 *  ExternalIdentifierQuery bean class
 */
public class ExternalIdentifierQuery implements org.apache.axis2.databinding.ADBBean {
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    ExternalIdentifierQuery.this.serialize(MY_QNAME, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localExternalIdentifierQuery.serialize(MY_QNAME, factory, xmlWriter);
    }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        throws org.apache.axis2.databinding.ADBException {
        //We can safely assume an element has only one type associated with it
        return localExternalIdentifierQuery.getPullParser(MY_QNAME);
    }
    ...
    public static class Factory {
         ...
         */
        public static ExternalIdentifierQuery parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ExternalIdentifierQuery object = new ExternalIdentifierQuery();
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    reader.getName())) {
                            object.setExternalIdentifierQuery(org.oasis.names.tc.ebxml_regrep.xsd.query.ExternalIdentifierQueryType.Factory.parse(
                                    reader));
