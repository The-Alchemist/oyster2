...
/**
 *  ObjectRefType bean class
 */
public class ObjectRefType extends org.oasis.names.tc.ebxml_regrep.xsd.rim.IdentifiableType
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for CreateReplica
     * This was an Attribute!
     */
    protected boolean localCreateReplica;
    ...
    public boolean getCreateReplica() {
        return localCreateReplica;
    }

    /**
     * Auto generated setter method
     * @param param CreateReplica
     */
    public void setCreateReplica(boolean param) {
        this.localCreateReplica = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    ObjectRefType.this.serialize(parentQName, factory, xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":ObjectRefType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "ObjectRefType", xmlWriter);
        }
        ...
        if (true) {
            writeAttribute("", "createReplica",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localCreateReplica), xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        attribList.add(new javax.xml.namespace.QName("", "createReplica"));
    ...
    public static class Factory {
         ...
         */
        public static ObjectRefType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObjectRefType object = new ObjectRefType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObjectRefType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ObjectRefType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                // handle attribute "createReplica"
                java.lang.String tempAttribCreateReplica = reader.getAttributeValue(null,
                        "createReplica");

                if (tempAttribCreateReplica != null) {
                    java.lang.String content = tempAttribCreateReplica;

                    object.setCreateReplica(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
                            tempAttribCreateReplica));
                } else {
                }

                handledAttributes.add("createReplica");
