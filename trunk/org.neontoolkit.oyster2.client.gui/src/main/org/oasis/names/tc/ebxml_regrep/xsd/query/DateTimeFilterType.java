...
/**
 *  DateTimeFilterType bean class
 */
public class DateTimeFilterType extends org.oasis.names.tc.ebxml_regrep.xsd.query.SimpleFilterType
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    DateTimeFilterType.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":DateTimeFilterType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "DateTimeFilterType", xmlWriter);
        }
        ...
        if (localValue != null) {
            /*writeAttribute("", "value",
                dateFormat.format(localValue.getTime()), xmlWriter);*/
            writeAttribute("", "value",org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
    ...
    public static class Factory {
         ...
         */
        public static DateTimeFilterType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DateTimeFilterType object = new DateTimeFilterType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DateTimeFilterType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (DateTimeFilterType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
