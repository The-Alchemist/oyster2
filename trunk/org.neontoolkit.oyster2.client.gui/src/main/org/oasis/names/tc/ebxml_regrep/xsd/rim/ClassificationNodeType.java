...
/**
 *  ClassificationNodeType bean class
 */
public class ClassificationNodeType extends org.oasis.names.tc.ebxml_regrep.xsd.rim.RegistryObjectType
     ...
     * This was an Attribute!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.LongName localCode;
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.LongName getCode() {
        return localCode;
    }
     ...
     * @param param Code
     */
    public void setCode(org.oasis.names.tc.ebxml_regrep.xsd.rim.LongName param) {
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    ClassificationNodeType.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":ClassificationNodeType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "ClassificationNodeType", xmlWriter);
        }
        ...
        if (localCode != null) {
            writeAttribute("", "code", localCode.toString(), xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        attribList.add(localCode.toString());

        attribList.add(new javax.xml.namespace.QName("", "path"));
    ...
    public static class Factory {
         ...
         */
        public static ClassificationNodeType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ClassificationNodeType object = new ClassificationNodeType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ClassificationNodeType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ClassificationNodeType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (tempAttribCode != null) {
                    ...
                    if (tempAttribCode.indexOf(":") > 0) {
                        // this seems to be a Qname so find the namespace and send
                        prefix = tempAttribCode.substring(0,
                                tempAttribCode.indexOf(":"));
                        namespaceuri = reader.getNamespaceURI(prefix);
                        object.setCode(org.oasis.names.tc.ebxml_regrep.xsd.rim.LongName.Factory.fromString(
                                tempAttribCode, namespaceuri));
                    } else {
                        // this seems to be not a qname send and empty namespace incase of it is
                        // check is done in fromString method
                        object.setCode(org.oasis.names.tc.ebxml_regrep.xsd.rim.LongName.Factory.fromString(
                ...
                java.lang.String tempAttribPath = reader.getAttributeValue(null,
                        "path");

                if (tempAttribPath != null) {
                    java.lang.String content = tempAttribPath;
