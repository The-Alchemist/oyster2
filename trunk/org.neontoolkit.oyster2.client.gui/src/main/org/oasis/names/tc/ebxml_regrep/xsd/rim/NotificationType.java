 ...
 */
public class NotificationType extends org.oasis.names.tc.ebxml_regrep.xsd.rim.RegistryObjectType
     ...
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI localSubscription;
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI getSubscription() {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":NotificationType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
        ...
        if (localSubscription != null) {
            writeAttribute("", "subscription", localSubscription.toString(),
                xmlWriter);
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "required attribute localSubscription is null");
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        attribList.add(new javax.xml.namespace.QName("", "subscription"));

        attribList.add(localSubscription.toString());
    ...
    public static class Factory {
        ...
        public static NotificationType parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"NotificationType".equals(type)) {
                            ...
                            return (NotificationType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                // handle attribute "subscription"
                java.lang.String tempAttribSubscription = reader.getAttributeValue(null,
                        "subscription");

                if (tempAttribSubscription != null) {
                    java.lang.String content = tempAttribSubscription;

                    if (tempAttribSubscription.indexOf(":") > 0) {
                        // this seems to be a Qname so find the namespace and send
                        prefix = tempAttribSubscription.substring(0,
                                tempAttribSubscription.indexOf(":"));
                        namespaceuri = reader.getNamespaceURI(prefix);
                        object.setSubscription(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribSubscription, namespaceuri));
                    } else {
                        // this seems to be not a qname send and empty namespace incase of it is
                        // check is done in fromString method
                        object.setSubscription(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribSubscription, ""));
                    }
                } else {
                    throw new org.apache.axis2.databinding.ADBException(
                        "Required attribute subscription is missing");
                }

                handledAttributes.add("subscription");
