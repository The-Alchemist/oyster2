...
/**
 *  AuditableEventType bean class
 */
public class AuditableEventType extends org.oasis.names.tc.ebxml_regrep.xsd.rim.RegistryObjectType
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for AffectedObjects
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ObjectRefListType localAffectedObjects;

    /**
     * field for EventType
     * This was an Attribute!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI localEventType;
     ...
     * This was an Attribute!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI localUser;

    /**
     * field for RequestId
     * This was an Attribute!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI localRequestId;
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ObjectRefListType getAffectedObjects() {
        return localAffectedObjects;
    }

    /**
     * Auto generated setter method
     * @param param AffectedObjects
     */
    public void setAffectedObjects(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.ObjectRefListType param) {
        this.localAffectedObjects = param;
    }
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI getEventType() {
     ...
     * @return org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI getUser() {
        return localUser;
    }
     ...
     * @return org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI getRequestId() {
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    AuditableEventType.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":AuditableEventType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "AuditableEventType", xmlWriter);
        }
        ...
        if (localEventType != null) {
            writeAttribute("", "eventType", localEventType.toString(), xmlWriter);
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "required attribute localEventType is null");
        }

        if (localTimestamp != null) {
            writeAttribute("", "timestamp",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localTimestamp), xmlWriter);
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "required attribute localTimestamp is null");
        }

        if (localUser != null) {
            writeAttribute("", "user", localUser.toString(), xmlWriter);
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "required attribute localUser is null");
        }

        if (localRequestId != null) {
            writeAttribute("", "requestId", localRequestId.toString(), xmlWriter);
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "required attribute localRequestId is null");
        }
        ...
        if (localAffectedObjects == null) {
            throw new org.apache.axis2.databinding.ADBException(
                "affectedObjects cannot be null!!");
        }

        localAffectedObjects.serialize(new javax.xml.namespace.QName(
                "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0", "affectedObjects"),
            factory, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        elementList.add(localAffectedObjects);
        ...
        attribList.add(new javax.xml.namespace.QName("", "eventType"));

        attribList.add(localEventType.toString());
        ...
        attribList.add(new javax.xml.namespace.QName("", "user"));

        attribList.add(localUser.toString());

        attribList.add(new javax.xml.namespace.QName("", "requestId"));

        attribList.add(localRequestId.toString());
    ...
    public static class Factory {
         ...
         */
        public static AuditableEventType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AuditableEventType object = new AuditableEventType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AuditableEventType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AuditableEventType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribEventType = reader.getAttributeValue(null,
                        "eventType");

                if (tempAttribEventType != null) {
                    java.lang.String content = tempAttribEventType;

                    if (tempAttribEventType.indexOf(":") > 0) {
                        // this seems to be a Qname so find the namespace and send
                        prefix = tempAttribEventType.substring(0,
                                tempAttribEventType.indexOf(":"));
                        namespaceuri = reader.getNamespaceURI(prefix);
                        object.setEventType(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribEventType, namespaceuri));
                    } else {
                        // this seems to be not a qname send and empty namespace incase of it is
                        // check is done in fromString method
                        object.setEventType(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                    ...
                    throw new org.apache.axis2.databinding.ADBException(
                        "Required attribute eventType is missing");
                }

                handledAttributes.add("eventType");

                // handle attribute "timestamp"
                java.lang.String tempAttribTimestamp = reader.getAttributeValue(null,
                        "timestamp");
                ...
                if (tempAttribTimestamp != null) {
                    ...
                    throw new org.apache.axis2.databinding.ADBException(
                        "Required attribute timestamp is missing");
                }

                handledAttributes.add("timestamp");

                // handle attribute "user"
                java.lang.String tempAttribUser = reader.getAttributeValue(null,
                        "user");

                if (tempAttribUser != null) {
                    java.lang.String content = tempAttribUser;

                    if (tempAttribUser.indexOf(":") > 0) {
                        // this seems to be a Qname so find the namespace and send
                        prefix = tempAttribUser.substring(0,
                                tempAttribUser.indexOf(":"));
                        namespaceuri = reader.getNamespaceURI(prefix);
                        object.setUser(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribUser, namespaceuri));
                    } else {
                        // this seems to be not a qname send and empty namespace incase of it is
                        // check is done in fromString method
                        object.setUser(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                    ...
                    throw new org.apache.axis2.databinding.ADBException(
                        "Required attribute user is missing");
                }

                handledAttributes.add("user");

                // handle attribute "requestId"
                java.lang.String tempAttribRequestId = reader.getAttributeValue(null,
                        "requestId");

                if (tempAttribRequestId != null) {
                    java.lang.String content = tempAttribRequestId;

                    if (tempAttribRequestId.indexOf(":") > 0) {
                        // this seems to be a Qname so find the namespace and send
                        prefix = tempAttribRequestId.substring(0,
                                tempAttribRequestId.indexOf(":"));
                        namespaceuri = reader.getNamespaceURI(prefix);
                        object.setRequestId(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribRequestId, namespaceuri));
                    } else {
                        // this seems to be not a qname send and empty namespace incase of it is
                        // check is done in fromString method
                        object.setRequestId(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                    ...
                    throw new org.apache.axis2.databinding.ADBException(
                        "Required attribute requestId is missing");
                }

                handledAttributes.add("requestId");
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0",
                            "affectedObjects").equals(reader.getName())) {
                    object.setAffectedObjects(org.oasis.names.tc.ebxml_regrep.xsd.rim.ObjectRefListType.Factory.parse(
                            reader));
