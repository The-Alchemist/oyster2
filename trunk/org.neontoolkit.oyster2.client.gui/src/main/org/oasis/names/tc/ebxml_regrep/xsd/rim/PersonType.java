 ...
 */
public class PersonType extends org.oasis.names.tc.ebxml_regrep.xsd.rim.RegistryObjectType
     ...
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.PersonNameType localPersonName;
    ...
    /**
     * Auto generated getter method
     * @return org.oasis.names.tc.ebxml_regrep.xsd.rim.PersonNameType
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.PersonNameType getPersonName() {
    ...
    public void setPersonName(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.PersonNameType param) {
        if (param != null) {
            //update the setting tracker
            localPersonNameTracker = true;
        } else {
            localPersonNameTracker = false;
        }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    PersonType.this.serialize(parentQName, factory, xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":PersonType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "PersonType", xmlWriter);
        }
        ...
        if (localPersonNameTracker) {
            if (localPersonName == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "PersonName cannot be null!!");
            }

            localPersonName.serialize(new javax.xml.namespace.QName(
                    "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0", "PersonName"),
                factory, xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static PersonType parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            PersonType object = new PersonType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"PersonType".equals(type)) {
                            ...
                            return (PersonType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setPersonName(org.oasis.names.tc.ebxml_regrep.xsd.rim.PersonNameType.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                    ...
                    // Process the array and step past its final element's end.
                    list9.add(org.oasis.names.tc.ebxml_regrep.xsd.rim.TelephoneNumberType.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                    ...
                    // Process the array and step past its final element's end.
                    list10.add(org.oasis.names.tc.ebxml_regrep.xsd.rim.EmailAddressType.Factory.parse(
                            reader));
