...
public class Oyster2Query extends DefaultHandler implements Serializable {
	 ...
	 * The message id.
	 */
	protected org.neontoolkit.registry.util.GUID mGUID = null;
	...
	public Oyster2Query(int scope, int type,String query) {
		mGUID = new org.neontoolkit.registry.util.GUID();
		mType = type;
		mQueryString = query;
		mScope=scope;
		relatedSearch = true;
	 ...
	 * @param query     the search string.
	 */
	public Oyster2Query(org.neontoolkit.registry.util.GUID guid, int scope, int type, String query) {
		mGUID = guid;
		mType = type;
		mQueryString = query;
		mScope=scope;
	 ...
	 */
	public org.neontoolkit.registry.util.GUID getGUID() {
		return mGUID;
	}
	 ...
	 */
	public void setGUID(org.neontoolkit.registry.util.GUID guid) {
		mGUID = guid;
	}
