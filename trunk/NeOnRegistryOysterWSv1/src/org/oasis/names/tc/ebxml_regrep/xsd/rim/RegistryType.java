...
/**
 *  RegistryType bean class
 */
public class RegistryType extends org.oasis.names.tc.ebxml_regrep.xsd.rim.RegistryObjectType
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for Operator
     * This was an Attribute!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI localOperator;

    /**
     * field for SpecificationVersion
     * This was an Attribute!
     */
    protected java.lang.String localSpecificationVersion;

    /**
     * field for ReplicationSyncLatency
     * This was an Attribute!
     */
    protected org.apache.axis2.databinding.types.Duration localReplicationSyncLatency;

    /**
     * field for CatalogingLatency
     * This was an Attribute!
     */
    protected org.apache.axis2.databinding.types.Duration localCatalogingLatency;

    /**
     * field for ConformanceProfile
     * This was an Attribute!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ConformanceProfileType localConformanceProfile;
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI getOperator() {
    ...
    public java.lang.String getSpecificationVersion() {
        return localSpecificationVersion;
    }

    /**
     * Auto generated setter method
     * @param param SpecificationVersion
     */
    public void setSpecificationVersion(java.lang.String param) {
        this.localSpecificationVersion = param;
    }
     ...
     */
    public org.apache.axis2.databinding.types.Duration getReplicationSyncLatency() {
        return localReplicationSyncLatency;
    }

    /**
     * Auto generated setter method
     * @param param ReplicationSyncLatency
     */
    public void setReplicationSyncLatency(
        org.apache.axis2.databinding.types.Duration param) {
        this.localReplicationSyncLatency = param;
    }
     ...
     * @return org.apache.axis2.databinding.types.Duration
     */
    public org.apache.axis2.databinding.types.Duration getCatalogingLatency() {
        return localCatalogingLatency;
    }

    /**
     * Auto generated setter method
     * @param param CatalogingLatency
     */
    public void setCatalogingLatency(
        org.apache.axis2.databinding.types.Duration param) {
        this.localCatalogingLatency = param;
    }

    /**
     * Auto generated getter method
     * @return org.oasis.names.tc.ebxml_regrep.xsd.rim.ConformanceProfileType
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ConformanceProfileType getConformanceProfile() {
        return localConformanceProfile;
    }

    /**
     * Auto generated setter method
     * @param param ConformanceProfile
     */
    public void setConformanceProfile(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.ConformanceProfileType param) {
        this.localConformanceProfile = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    RegistryType.this.serialize(parentQName, factory, xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":RegistryType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "RegistryType", xmlWriter);
        }
        ...
        if (localOperator != null) {
            writeAttribute("", "operator", localOperator.toString(), xmlWriter);
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "required attribute localOperator is null");
        }

        if (localSpecificationVersion != null) {
            writeAttribute("", "specificationVersion",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localSpecificationVersion), xmlWriter);
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "required attribute localSpecificationVersion is null");
        }

        if (localReplicationSyncLatency != null) {
            writeAttribute("", "replicationSyncLatency",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localReplicationSyncLatency), xmlWriter);
        }

        if (localCatalogingLatency != null) {
            writeAttribute("", "catalogingLatency",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localCatalogingLatency), xmlWriter);
        }

        if (localConformanceProfile != null) {
            writeAttribute("", "conformanceProfile",
                localConformanceProfile.toString(), xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        attribList.add(new javax.xml.namespace.QName("", "operator"));

        attribList.add(localOperator.toString());

        attribList.add(new javax.xml.namespace.QName("", "specificationVersion"));

        attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                localSpecificationVersion));

        attribList.add(new javax.xml.namespace.QName("",
                "replicationSyncLatency"));

        attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                localReplicationSyncLatency));

        attribList.add(new javax.xml.namespace.QName("", "catalogingLatency"));

        attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                localCatalogingLatency));

        attribList.add(new javax.xml.namespace.QName("", "conformanceProfile"));

        attribList.add(localConformanceProfile.toString());
    ...
    public static class Factory {
         ...
         */
        public static RegistryType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RegistryType object = new RegistryType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RegistryType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RegistryType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribOperator = reader.getAttributeValue(null,
                        "operator");

                if (tempAttribOperator != null) {
                    java.lang.String content = tempAttribOperator;

                    if (tempAttribOperator.indexOf(":") > 0) {
                        // this seems to be a Qname so find the namespace and send
                        prefix = tempAttribOperator.substring(0,
                                tempAttribOperator.indexOf(":"));
                        namespaceuri = reader.getNamespaceURI(prefix);
                        object.setOperator(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribOperator, namespaceuri));
                    } else {
                        // this seems to be not a qname send and empty namespace incase of it is
                        // check is done in fromString method
                        object.setOperator(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                    ...
                    throw new org.apache.axis2.databinding.ADBException(
                        "Required attribute operator is missing");
                }

                handledAttributes.add("operator");

                // handle attribute "specificationVersion"
                java.lang.String tempAttribSpecificationVersion = reader.getAttributeValue(null,
                        "specificationVersion");

                if (tempAttribSpecificationVersion != null) {
                    java.lang.String content = tempAttribSpecificationVersion;

                    object.setSpecificationVersion(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribSpecificationVersion));
                } else {
                    throw new org.apache.axis2.databinding.ADBException(
                        "Required attribute specificationVersion is missing");
                }

                handledAttributes.add("specificationVersion");

                // handle attribute "replicationSyncLatency"
                java.lang.String tempAttribReplicationSyncLatency = reader.getAttributeValue(null,
                        "replicationSyncLatency");

                if (tempAttribReplicationSyncLatency != null) {
                    java.lang.String content = tempAttribReplicationSyncLatency;

                    object.setReplicationSyncLatency(org.apache.axis2.databinding.utils.ConverterUtil.convertToDuration(
                            tempAttribReplicationSyncLatency));
                } else {
                }

                handledAttributes.add("replicationSyncLatency");

                // handle attribute "catalogingLatency"
                java.lang.String tempAttribCatalogingLatency = reader.getAttributeValue(null,
                        "catalogingLatency");

                if (tempAttribCatalogingLatency != null) {
                    java.lang.String content = tempAttribCatalogingLatency;

                    object.setCatalogingLatency(org.apache.axis2.databinding.utils.ConverterUtil.convertToDuration(
                            tempAttribCatalogingLatency));
                } else {
                }

                handledAttributes.add("catalogingLatency");

                // handle attribute "conformanceProfile"
                java.lang.String tempAttribConformanceProfile = reader.getAttributeValue(null,
                        "conformanceProfile");

                if (tempAttribConformanceProfile != null) {
                    java.lang.String content = tempAttribConformanceProfile;

                    if (tempAttribConformanceProfile.indexOf(":") > 0) {
                        // this seems to be a Qname so find the namespace and send
                        prefix = tempAttribConformanceProfile.substring(0,
                                tempAttribConformanceProfile.indexOf(":"));
                        namespaceuri = reader.getNamespaceURI(prefix);
                        object.setConformanceProfile(org.oasis.names.tc.ebxml_regrep.xsd.rim.ConformanceProfileType.Factory.fromString(
                                tempAttribConformanceProfile, namespaceuri));
                    } else {
                        // this seems to be not a qname send and empty namespace incase of it is
                        // check is done in fromString method
                        object.setConformanceProfile(org.oasis.names.tc.ebxml_regrep.xsd.rim.ConformanceProfileType.Factory.fromString(
                                tempAttribConformanceProfile, ""));
                    }
                } else {
                }

                handledAttributes.add("conformanceProfile");
