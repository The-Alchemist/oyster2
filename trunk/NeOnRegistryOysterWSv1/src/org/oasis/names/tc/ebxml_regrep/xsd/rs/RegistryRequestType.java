...
/**
 *  RegistryRequestType bean class
 */
public class RegistryRequestType implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for RequestSlotList
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.SlotListType localRequestSlotList;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localRequestSlotListTracker = false;
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.SlotListType getRequestSlotList() {
        return localRequestSlotList;
    }

    /**
     * Auto generated setter method
     * @param param RequestSlotList
     */
    public void setRequestSlotList(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.SlotListType param) {
        if (param != null) {
            //update the setting tracker
            localRequestSlotListTracker = true;
        } else {
            localRequestSlotListTracker = false;
        }

        this.localRequestSlotList = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    RegistryRequestType.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public static class Factory {
         ...
         */
        public static RegistryRequestType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RegistryRequestType object = new RegistryRequestType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RegistryRequestType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RegistryRequestType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
