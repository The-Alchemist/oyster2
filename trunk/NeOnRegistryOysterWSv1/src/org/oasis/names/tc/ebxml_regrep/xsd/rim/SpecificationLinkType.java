...
/**
 *  SpecificationLinkType bean class
 */
public class SpecificationLinkType extends org.oasis.names.tc.ebxml_regrep.xsd.rim.RegistryObjectType
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for UsageDescription
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.InternationalStringType localUsageDescription;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localUsageDescriptionTracker = false;

    /**
     * field for UsageParameter
     * This was an Array!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.FreeFormText[] localUsageParameter;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localUsageParameterTracker = false;

    /**
     * field for ServiceBinding
     * This was an Attribute!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI localServiceBinding;

    /**
     * field for SpecificationObject
     * This was an Attribute!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI localSpecificationObject;
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.InternationalStringType getUsageDescription() {
        return localUsageDescription;
    }

    /**
     * Auto generated setter method
     * @param param UsageDescription
     */
    public void setUsageDescription(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.InternationalStringType param) {
        if (param != null) {
            //update the setting tracker
            localUsageDescriptionTracker = true;
        } else {
            localUsageDescriptionTracker = false;
        }

        this.localUsageDescription = param;
    }
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.FreeFormText[] getUsageParameter() {
        return localUsageParameter;
    }

    /**
     * validate the array for UsageParameter
     */
    protected void validateUsageParameter(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.FreeFormText[] param) {
    }

    /**
     * Auto generated setter method
     * @param param UsageParameter
     */
    public void setUsageParameter(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.FreeFormText[] param) {
        validateUsageParameter(param);

        if (param != null) {
            //update the setting tracker
            localUsageParameterTracker = true;
        } else {
            localUsageParameterTracker = false;
        }

        this.localUsageParameter = param;
    }

    /**
     * Auto generated add method for the array for convenience
     * @param param org.oasis.names.tc.ebxml_regrep.xsd.rim.FreeFormText
     */
    public void addUsageParameter(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.FreeFormText param) {
        if (localUsageParameter == null) {
            localUsageParameter = new org.oasis.names.tc.ebxml_regrep.xsd.rim.FreeFormText[] {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localUsageParameter);
        list.add(param);
        this.localUsageParameter = (org.oasis.names.tc.ebxml_regrep.xsd.rim.FreeFormText[]) list.toArray(new org.oasis.names.tc.ebxml_regrep.xsd.rim.FreeFormText[list.size()]);
    }
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI getServiceBinding() {
     ...
     * @return org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI getSpecificationObject() {
        return localSpecificationObject;
    }

    /**
     * Auto generated setter method
     * @param param SpecificationObject
     */
    public void setSpecificationObject(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI param) {
        this.localSpecificationObject = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    SpecificationLinkType.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":SpecificationLinkType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "SpecificationLinkType", xmlWriter);
        }
        ...
        if (localServiceBinding != null) {
            writeAttribute("", "serviceBinding",
                localServiceBinding.toString(), xmlWriter);
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "required attribute localServiceBinding is null");
        }

        if (localSpecificationObject != null) {
            writeAttribute("", "specificationObject",
                localSpecificationObject.toString(), xmlWriter);
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "required attribute localSpecificationObject is null");
        }
        ...
        if (localUsageDescriptionTracker) {
            if (localUsageDescription == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "UsageDescription cannot be null!!");
            }

            localUsageDescription.serialize(new javax.xml.namespace.QName(
                    "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0",
                    "UsageDescription"), factory, xmlWriter);
        }

        if (localUsageParameterTracker) {
            if (localUsageParameter != null) {
                for (int i = 0; i < localUsageParameter.length; i++) {
                    if (localUsageParameter[i] != null) {
                        localUsageParameter[i].serialize(new javax.xml.namespace.QName(
                                "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0",
                                "UsageParameter"), factory, xmlWriter);
                    } else {
                        // we don't have to do any thing since minOccures is zero
                    }
                }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localUsageDescriptionTracker) {
            ...
            elementList.add(localUsageDescription);
        }
                ...
                for (int i = 0; i < localUsageParameter.length; i++) {
                    if (localUsageParameter[i] != null) {
                        elementList.add(new javax.xml.namespace.QName(
                                "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0",
                                "UsageParameter"));
                        elementList.add(localUsageParameter[i]);
                    } else {
                        // nothing to do
                    }
                }
        ...
        attribList.add(new javax.xml.namespace.QName("", "serviceBinding"));

        attribList.add(localServiceBinding.toString());

        attribList.add(new javax.xml.namespace.QName("", "specificationObject"));

        attribList.add(localSpecificationObject.toString());
    ...
    public static class Factory {
         ...
         */
        public static SpecificationLinkType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SpecificationLinkType object = new SpecificationLinkType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SpecificationLinkType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SpecificationLinkType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                // handle attribute "serviceBinding"
                java.lang.String tempAttribServiceBinding = reader.getAttributeValue(null,
                        "serviceBinding");

                if (tempAttribServiceBinding != null) {
                    java.lang.String content = tempAttribServiceBinding;

                    if (tempAttribServiceBinding.indexOf(":") > 0) {
                        // this seems to be a Qname so find the namespace and send
                        prefix = tempAttribServiceBinding.substring(0,
                                tempAttribServiceBinding.indexOf(":"));
                        namespaceuri = reader.getNamespaceURI(prefix);
                        object.setServiceBinding(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribServiceBinding, namespaceuri));
                    } else {
                        // this seems to be not a qname send and empty namespace incase of it is
                        // check is done in fromString method
                        object.setServiceBinding(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribServiceBinding, ""));
                    }
                } else {
                    throw new org.apache.axis2.databinding.ADBException(
                        "Required attribute serviceBinding is missing");
                }

                handledAttributes.add("serviceBinding");

                // handle attribute "specificationObject"
                java.lang.String tempAttribSpecificationObject = reader.getAttributeValue(null,
                        "specificationObject");

                if (tempAttribSpecificationObject != null) {
                    java.lang.String content = tempAttribSpecificationObject;

                    if (tempAttribSpecificationObject.indexOf(":") > 0) {
                        // this seems to be a Qname so find the namespace and send
                        prefix = tempAttribSpecificationObject.substring(0,
                                tempAttribSpecificationObject.indexOf(":"));
                        namespaceuri = reader.getNamespaceURI(prefix);
                        object.setSpecificationObject(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribSpecificationObject, namespaceuri));
                    } else {
                        // this seems to be not a qname send and empty namespace incase of it is
                        // check is done in fromString method
                        object.setSpecificationObject(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribSpecificationObject, ""));
                    }
                } else {
                    throw new org.apache.axis2.databinding.ADBException(
                        "Required attribute specificationObject is missing");
                }

                handledAttributes.add("specificationObject");
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0",
                            "UsageDescription").equals(reader.getName())) {
                    object.setUsageDescription(org.oasis.names.tc.ebxml_regrep.xsd.rim.InternationalStringType.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0",
                            "UsageParameter").equals(reader.getName())) {
                    // Process the array and step past its final element's end.
                    list8.add(org.oasis.names.tc.ebxml_regrep.xsd.rim.FreeFormText.Factory.parse(
                            reader));
                    ...
                    // call the converter utility  to convert and set the array
                    object.setUsageParameter((org.oasis.names.tc.ebxml_regrep.xsd.rim.FreeFormText[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            org.oasis.names.tc.ebxml_regrep.xsd.rim.FreeFormText.class,
                            list8));
                } // End of if for expected property start element
