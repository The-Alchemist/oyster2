...
/**
 *  TelephoneNumber bean class
 */
public class TelephoneNumber implements org.apache.axis2.databinding.ADBBean {
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    TelephoneNumber.this.serialize(MY_QNAME, factory, xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localTelephoneNumber.serialize(MY_QNAME, factory, xmlWriter);
    }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        throws org.apache.axis2.databinding.ADBException {
        //We can safely assume an element has only one type associated with it
        return localTelephoneNumber.getPullParser(MY_QNAME);
    }
    ...
    public static class Factory {
         ...
         */
        public static TelephoneNumber parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TelephoneNumber object = new TelephoneNumber();
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                            ...
                            object.setTelephoneNumber(org.oasis.names.tc.ebxml_regrep.xsd.rim.TelephoneNumberType.Factory.parse(
                                    reader));
