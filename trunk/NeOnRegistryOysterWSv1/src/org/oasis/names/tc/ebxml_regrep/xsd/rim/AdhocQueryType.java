...
/**
 *  AdhocQueryType bean class
 */
public class AdhocQueryType extends org.oasis.names.tc.ebxml_regrep.xsd.rim.RegistryObjectType
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for QueryExpression
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.QueryExpressionType localQueryExpression;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localQueryExpressionTracker = false;
     ...
     * @return org.oasis.names.tc.ebxml_regrep.xsd.rim.QueryExpressionType
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.QueryExpressionType getQueryExpression() {
        return localQueryExpression;
    }

    /**
     * Auto generated setter method
     * @param param QueryExpression
     */
    public void setQueryExpression(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.QueryExpressionType param) {
        if (param != null) {
            //update the setting tracker
            localQueryExpressionTracker = true;
        } else {
            localQueryExpressionTracker = false;
        }

        this.localQueryExpression = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    AdhocQueryType.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":AdhocQueryType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "AdhocQueryType", xmlWriter);
        }
        ...
        if (localQueryExpressionTracker) {
            if (localQueryExpression == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "QueryExpression cannot be null!!");
            }

            localQueryExpression.serialize(new javax.xml.namespace.QName(
                    "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0",
                    "QueryExpression"), factory, xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        attribList.add(new javax.xml.namespace.QName(
                "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0", "AdhocQueryType"));
        ...
        if (localQueryExpressionTracker) {
            ...
            elementList.add(localQueryExpression);
        }
    ...
    public static class Factory {
         ...
         */
        public static AdhocQueryType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AdhocQueryType object = new AdhocQueryType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AdhocQueryType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AdhocQueryType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0",
                            "QueryExpression").equals(reader.getName())) {
                    object.setQueryExpression(org.oasis.names.tc.ebxml_regrep.xsd.rim.QueryExpressionType.Factory.parse(
                            reader));
