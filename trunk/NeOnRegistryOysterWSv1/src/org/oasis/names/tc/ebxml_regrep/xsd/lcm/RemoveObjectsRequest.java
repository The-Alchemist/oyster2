...
/**
 *  RemoveObjectsRequest bean class
 */
public class RemoveObjectsRequest extends org.oasis.names.tc.ebxml_regrep.xsd.rs.RegistryRequestType
    ...
    /**
     * field for DeletionScope
     * This was an Attribute!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI localDeletionScope;
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI getDeletionScope() {
        return localDeletionScope;
    }

    /**
     * Auto generated setter method
     * @param param DeletionScope
     */
    public void setDeletionScope(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI param) {
        this.localDeletionScope = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    RemoveObjectsRequest.this.serialize(MY_QNAME, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":RemoveObjectsRequest", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "RemoveObjectsRequest", xmlWriter);
        }
        ...
        if (localDeletionScope != null) {
            writeAttribute("", "deletionScope", localDeletionScope.toString(),
                xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        attribList.add(new javax.xml.namespace.QName("", "deletionScope"));

        attribList.add(localDeletionScope.toString());
    ...
    public static class Factory {
         ...
         */
        public static RemoveObjectsRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RemoveObjectsRequest object = new RemoveObjectsRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RemoveObjectsRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RemoveObjectsRequest) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                // handle attribute "deletionScope"
                java.lang.String tempAttribDeletionScope = reader.getAttributeValue(null,
                        "deletionScope");

                if (tempAttribDeletionScope != null) {
                    java.lang.String content = tempAttribDeletionScope;

                    if (tempAttribDeletionScope.indexOf(":") > 0) {
                        // this seems to be a Qname so find the namespace and send
                        prefix = tempAttribDeletionScope.substring(0,
                                tempAttribDeletionScope.indexOf(":"));
                        namespaceuri = reader.getNamespaceURI(prefix);
                        object.setDeletionScope(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribDeletionScope, namespaceuri));
                    } else {
                        // this seems to be not a qname send and empty namespace incase of it is
                        // check is done in fromString method
                        object.setDeletionScope(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribDeletionScope, ""));
                    }
                } else {
                }

                handledAttributes.add("deletionScope");
