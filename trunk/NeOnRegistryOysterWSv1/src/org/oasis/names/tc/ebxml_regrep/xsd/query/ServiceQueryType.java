...
/**
 *  ServiceQueryType bean class
 */
public class ServiceQueryType extends org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType
    ...
    /**
     * validate the array for ServiceBindingQuery
     */
    protected void validateServiceBindingQuery(
    ...
    public void setServiceBindingQuery(
        org.oasis.names.tc.ebxml_regrep.xsd.query.ServiceBindingQueryType[] param) {
        validateServiceBindingQuery(param);
     ...
     * @param param org.oasis.names.tc.ebxml_regrep.xsd.query.ServiceBindingQueryType
     */
    public void addServiceBindingQuery(
        org.oasis.names.tc.ebxml_regrep.xsd.query.ServiceBindingQueryType param) {
        if (localServiceBindingQuery == null) {
            localServiceBindingQuery = new org.oasis.names.tc.ebxml_regrep.xsd.query.ServiceBindingQueryType[] {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localServiceBindingQuery);
        list.add(param);
        this.localServiceBindingQuery = (org.oasis.names.tc.ebxml_regrep.xsd.query.ServiceBindingQueryType[]) list.toArray(new org.oasis.names.tc.ebxml_regrep.xsd.query.ServiceBindingQueryType[list.size()]);
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    ServiceQueryType.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":ServiceQueryType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "ServiceQueryType", xmlWriter);
        }
        ...
        if (localServiceBindingQueryTracker) {
            if (localServiceBindingQuery != null) {
                for (int i = 0; i < localServiceBindingQuery.length; i++) {
                    if (localServiceBindingQuery[i] != null) {
                        localServiceBindingQuery[i].serialize(new javax.xml.namespace.QName(
                                "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                ...
                for (int i = 0; i < localServiceBindingQuery.length; i++) {
                    if (localServiceBindingQuery[i] != null) {
                        elementList.add(new javax.xml.namespace.QName(
                                "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                                "ServiceBindingQuery"));
                        elementList.add(localServiceBindingQuery[i]);
                    } else {
                        // nothing to do
                    }
                }
    ...
    public static class Factory {
         ...
         */
        public static ServiceQueryType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ServiceQueryType object = new ServiceQueryType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ServiceQueryType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ServiceQueryType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    // Process the array and step past its final element's end.
                    list12.add(org.oasis.names.tc.ebxml_regrep.xsd.query.ServiceBindingQueryType.Factory.parse(
                            reader));
                    ...
                    // call the converter utility  to convert and set the array
                    object.setServiceBindingQuery((org.oasis.names.tc.ebxml_regrep.xsd.query.ServiceBindingQueryType[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            org.oasis.names.tc.ebxml_regrep.xsd.query.ServiceBindingQueryType.class,
                            list12));
                } // End of if for expected property start element
