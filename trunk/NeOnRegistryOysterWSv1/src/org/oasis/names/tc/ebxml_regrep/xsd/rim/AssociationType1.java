...
/**
 *  AssociationType1 bean class
 */
public class AssociationType1 extends org.oasis.names.tc.ebxml_regrep.xsd.rim.RegistryObjectType
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for AssociationType
     * This was an Attribute!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI localAssociationType;

    /**
     * field for SourceObject
     * This was an Attribute!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI localSourceObject;

    /**
     * field for TargetObject
     * This was an Attribute!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI localTargetObject;
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI getAssociationType() {
     ...
     * @return org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI getSourceObject() {
     ...
     * @return org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI getTargetObject() {
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    AssociationType1.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":AssociationType1", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "AssociationType1", xmlWriter);
        }
        ...
        if (localAssociationType != null) {
            writeAttribute("", "associationType",
                localAssociationType.toString(), xmlWriter);
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "required attribute localAssociationType is null");
        }

        if (localSourceObject != null) {
            writeAttribute("", "sourceObject", localSourceObject.toString(),
                xmlWriter);
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "required attribute localSourceObject is null");
        }

        if (localTargetObject != null) {
            writeAttribute("", "targetObject", localTargetObject.toString(),
                xmlWriter);
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "required attribute localTargetObject is null");
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        attribList.add(new javax.xml.namespace.QName("", "associationType"));

        attribList.add(localAssociationType.toString());

        attribList.add(new javax.xml.namespace.QName("", "sourceObject"));

        attribList.add(localSourceObject.toString());

        attribList.add(new javax.xml.namespace.QName("", "targetObject"));

        attribList.add(localTargetObject.toString());
    ...
    public static class Factory {
         ...
         */
        public static AssociationType1 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AssociationType1 object = new AssociationType1();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AssociationType1".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AssociationType1) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                // handle attribute "associationType"
                java.lang.String tempAttribAssociationType = reader.getAttributeValue(null,
                        "associationType");

                if (tempAttribAssociationType != null) {
                    java.lang.String content = tempAttribAssociationType;

                    if (tempAttribAssociationType.indexOf(":") > 0) {
                        // this seems to be a Qname so find the namespace and send
                        prefix = tempAttribAssociationType.substring(0,
                                tempAttribAssociationType.indexOf(":"));
                        namespaceuri = reader.getNamespaceURI(prefix);
                        object.setAssociationType(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribAssociationType, namespaceuri));
                    } else {
                        // this seems to be not a qname send and empty namespace incase of it is
                        // check is done in fromString method
                        object.setAssociationType(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribAssociationType, ""));
                    }
                } else {
                    throw new org.apache.axis2.databinding.ADBException(
                        "Required attribute associationType is missing");
                }

                handledAttributes.add("associationType");

                // handle attribute "sourceObject"
                java.lang.String tempAttribSourceObject = reader.getAttributeValue(null,
                        "sourceObject");

                if (tempAttribSourceObject != null) {
                    java.lang.String content = tempAttribSourceObject;

                    if (tempAttribSourceObject.indexOf(":") > 0) {
                        // this seems to be a Qname so find the namespace and send
                        prefix = tempAttribSourceObject.substring(0,
                                tempAttribSourceObject.indexOf(":"));
                        namespaceuri = reader.getNamespaceURI(prefix);
                        object.setSourceObject(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribSourceObject, namespaceuri));
                    } else {
                        // this seems to be not a qname send and empty namespace incase of it is
                        // check is done in fromString method
                        object.setSourceObject(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribSourceObject, ""));
                    }
                } else {
                    throw new org.apache.axis2.databinding.ADBException(
                        "Required attribute sourceObject is missing");
                }

                handledAttributes.add("sourceObject");

                // handle attribute "targetObject"
                java.lang.String tempAttribTargetObject = reader.getAttributeValue(null,
                        "targetObject");

                if (tempAttribTargetObject != null) {
                    java.lang.String content = tempAttribTargetObject;

                    if (tempAttribTargetObject.indexOf(":") > 0) {
                        // this seems to be a Qname so find the namespace and send
                        prefix = tempAttribTargetObject.substring(0,
                                tempAttribTargetObject.indexOf(":"));
                        namespaceuri = reader.getNamespaceURI(prefix);
                        object.setTargetObject(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribTargetObject, namespaceuri));
                    } else {
                        // this seems to be not a qname send and empty namespace incase of it is
                        // check is done in fromString method
                        object.setTargetObject(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribTargetObject, ""));
                    }
                } else {
                    throw new org.apache.axis2.databinding.ADBException(
                        "Required attribute targetObject is missing");
                }

                handledAttributes.add("targetObject");
