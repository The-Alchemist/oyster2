...
/**
 *  SpecificationLinkQueryType bean class
 */
public class SpecificationLinkQueryType extends org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for UsageDescriptionBranch
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.query.InternationalStringBranchType localUsageDescriptionBranch;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localUsageDescriptionBranchTracker = false;

    /**
     * field for ServiceBindingQuery
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.query.ServiceBindingQueryType localServiceBindingQuery;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localServiceBindingQueryTracker = false;

    /**
     * field for SpecificationObjectQuery
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType localSpecificationObjectQuery;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localSpecificationObjectQueryTracker = false;
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.query.InternationalStringBranchType getUsageDescriptionBranch() {
        return localUsageDescriptionBranch;
    }

    /**
     * Auto generated setter method
     * @param param UsageDescriptionBranch
     */
    public void setUsageDescriptionBranch(
        org.oasis.names.tc.ebxml_regrep.xsd.query.InternationalStringBranchType param) {
        if (param != null) {
            //update the setting tracker
            localUsageDescriptionBranchTracker = true;
        } else {
            localUsageDescriptionBranchTracker = false;
        }

        this.localUsageDescriptionBranch = param;
    }
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.query.ServiceBindingQueryType getServiceBindingQuery() {
        return localServiceBindingQuery;
    }

    /**
     * Auto generated setter method
     * @param param ServiceBindingQuery
     */
    public void setServiceBindingQuery(
        org.oasis.names.tc.ebxml_regrep.xsd.query.ServiceBindingQueryType param) {
        if (param != null) {
            //update the setting tracker
            localServiceBindingQueryTracker = true;
        } else {
            localServiceBindingQueryTracker = false;
        }

        this.localServiceBindingQuery = param;
    }
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType getSpecificationObjectQuery() {
        return localSpecificationObjectQuery;
    }

    /**
     * Auto generated setter method
     * @param param SpecificationObjectQuery
     */
    public void setSpecificationObjectQuery(
        org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType param) {
        if (param != null) {
            //update the setting tracker
            localSpecificationObjectQueryTracker = true;
        } else {
            localSpecificationObjectQueryTracker = false;
        }

        this.localSpecificationObjectQuery = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    SpecificationLinkQueryType.this.serialize(parentQName,
                        factory, xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":SpecificationLinkQueryType",
                xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "SpecificationLinkQueryType", xmlWriter);
        }
        ...
        if (localUsageDescriptionBranchTracker) {
            if (localUsageDescriptionBranch == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "UsageDescriptionBranch cannot be null!!");
            }

            localUsageDescriptionBranch.serialize(new javax.xml.namespace.QName(
                    "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                    "UsageDescriptionBranch"), factory, xmlWriter);
        }

        if (localServiceBindingQueryTracker) {
            if (localServiceBindingQuery == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "ServiceBindingQuery cannot be null!!");
            }

            localServiceBindingQuery.serialize(new javax.xml.namespace.QName(
                    "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                    "ServiceBindingQuery"), factory, xmlWriter);
        }

        if (localSpecificationObjectQueryTracker) {
            if (localSpecificationObjectQuery == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "SpecificationObjectQuery cannot be null!!");
            }

            localSpecificationObjectQuery.serialize(new javax.xml.namespace.QName(
                    "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                    "SpecificationObjectQuery"), factory, xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localUsageDescriptionBranchTracker) {
            ...
            elementList.add(localUsageDescriptionBranch);
        }
        ...
        if (localServiceBindingQueryTracker) {
            ...
            elementList.add(localServiceBindingQuery);
        }
        ...
        if (localSpecificationObjectQueryTracker) {
            ...
            elementList.add(localSpecificationObjectQuery);
        }
    ...
    public static class Factory {
         ...
         */
        public static SpecificationLinkQueryType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SpecificationLinkQueryType object = new SpecificationLinkQueryType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SpecificationLinkQueryType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SpecificationLinkQueryType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                            "UsageDescriptionBranch").equals(reader.getName())) {
                    object.setUsageDescriptionBranch(org.oasis.names.tc.ebxml_regrep.xsd.query.InternationalStringBranchType.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                            "ServiceBindingQuery").equals(reader.getName())) {
                    object.setServiceBindingQuery(org.oasis.names.tc.ebxml_regrep.xsd.query.ServiceBindingQueryType.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                            "SpecificationObjectQuery").equals(reader.getName())) {
                    object.setSpecificationObjectQuery(org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType.Factory.parse(
                            reader));
