...
/**
 *  OntologyType_Type bean class
 */
public class OntologyType_Type extends org.neon_toolkit.registry.omv.xsd.rim.OMVRegistryObjectType
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for DefinedBy
     * This was an Array!
     */
    protected org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[] localDefinedBy;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localDefinedByTracker = false;

    /* This type was generated from the piece of schema that had
       name = OntologyType_Type
     ...
     */
    public org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[] getDefinedBy() {
        return localDefinedBy;
    }

    /**
     * validate the array for DefinedBy
     */
    protected void validateDefinedBy(
        org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[] param) {
    }

    /**
     * Auto generated setter method
     * @param param DefinedBy
     */
    public void setDefinedBy(
        org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[] param) {
        validateDefinedBy(param);

        if (param != null) {
            //update the setting tracker
            localDefinedByTracker = true;
        } else {
            localDefinedByTracker = false;
        }

        this.localDefinedBy = param;
    }
     ...
     */
    public void addDefinedBy(
        org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType param) {
        if (localDefinedBy == null) {
            localDefinedBy = new org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[] {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localDefinedBy);
        list.add(param);
        this.localDefinedBy = (org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[]) list.toArray(new org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[list.size()]);
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    OntologyType_Type.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":OntologyType_Type", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "OntologyType_Type", xmlWriter);
        }
        ...
        if (localDefinedByTracker) {
            if (localDefinedBy != null) {
                for (int i = 0; i < localDefinedBy.length; i++) {
                    if (localDefinedBy[i] != null) {
                        localDefinedBy[i].serialize(new javax.xml.namespace.QName(
                                "urn:neon-toolkit-org:registry:omv:xsd:rim:2.3",
                                "definedBy"), factory, xmlWriter);
                    } else {
                        // we don't have to do any thing since minOccures is zero
                    }
                }
                ...
                for (int i = 0; i < localDefinedBy.length; i++) {
                    if (localDefinedBy[i] != null) {
                        elementList.add(new javax.xml.namespace.QName(
                                "urn:neon-toolkit-org:registry:omv:xsd:rim:2.3",
                                "definedBy"));
                        elementList.add(localDefinedBy[i]);
                    } else {
                        // nothing to do
                    }
                }
    ...
    public static class Factory {
         ...
         */
        public static OntologyType_Type parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            OntologyType_Type object = new OntologyType_Type();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"OntologyType_Type".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (OntologyType_Type) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:neon-toolkit-org:registry:omv:xsd:rim:2.3",
                            "definedBy").equals(reader.getName())) {
                    // Process the array and step past its final element's end.
                    ...
                    // call the converter utility  to convert and set the array
                    object.setDefinedBy((org.neon_toolkit.registry.omv.xsd.rim.OMVObjectRefType[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
