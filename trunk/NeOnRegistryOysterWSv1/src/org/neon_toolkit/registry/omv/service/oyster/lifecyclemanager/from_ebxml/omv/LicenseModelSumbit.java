...
public class LicenseModelSumbit extends OMVRegistryObjectSubmit {
	public static Object submit(LicenseModelType input, Object outputIn) {
		OMVLicenseModel output;
		if (outputIn==null) output = new OMVLicenseModel();
		else output = ((OMVLicenseModel)outputIn);
