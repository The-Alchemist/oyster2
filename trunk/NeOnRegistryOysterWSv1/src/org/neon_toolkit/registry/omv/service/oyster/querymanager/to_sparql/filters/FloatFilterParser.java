 ...
 *
 */
public class FloatFilterParser extends SimpleFilterParser {
	public static String parse(FloatFilterType filter, String attribute, int icond) throws Exception {
		String result;
		...
		*/
		...
		if (filter.getComparator().getValue().equals(ComparatorType._GE))
			...
			throw new Exception("Comparator now allowed with Float filters.");
