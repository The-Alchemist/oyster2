...
/**
 * Parses a OntologyEngineeringTool query. This object is ment to be used by RegistryObjectQueryParser. 
 * Please use RegistryObjectQueryParser.parse 
 * 
 * @author wrkboy
 *
 */
public class OntologyEngineeringToolQueryParser extends
		RegistryObjectQueryParser {
	
	public static OntologyEngineeringToolQueryParser parse(OntologyEngineeringToolQueryType query, String ref) {
		OntologyEngineeringToolQueryParser result = new OntologyEngineeringToolQueryParser();
