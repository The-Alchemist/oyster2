...
public class OntologySyntaxSubmit extends OMVRegistryObjectSubmit {
	public static Object submit(OntologySyntaxType input, Object outputIn) {
		
		OMVOntologySyntax output;
		if (outputIn==null) output = new OMVOntologySyntax();
		else output = ((OMVOntologySyntax)outputIn);
