package org.neon_toolkit.registry.omv.service.oyster.querymanager.to_ebxml;
...
import org.oasis.names.tc.ebxml_regrep.xsd.rim.LongName;
import org.oasis.names.tc.ebxml_regrep.xsd.rim.ObjectRef;
...
import org.oasis.names.tc.ebxml_regrep.xsd.rim.String16;
import org.oasis.names.tc.ebxml_regrep.xsd.rim.String32;
import org.oasis.names.tc.ebxml_regrep.xsd.rim.String8;
import org.oasis.names.tc.ebxml_regrep.xsd.rim.TelephoneNumberType;
import org.oasis.names.tc.ebxml_regrep.xsd.rim.ValueListType;
import org.oasis.names.tc.ebxml_regrep.xsd.rim.ValueListTypeSequence;
import org.oasis.names.tc.ebxml_regrep.xsd.rim.VersionInfoType;
...
//		System.out.println(input.getKey().getId() +" - "+ flattenInternationalString(input.getName()));
    ...
    */
    ...
    public static ReferenceURI makeReferenceURI4OMV(String params) {
    	URI param;
		try {
