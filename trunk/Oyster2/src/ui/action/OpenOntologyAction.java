...
public class OpenOntologyAction extends Action implements IRunnableWithProgress {
	...
	public OpenOntologyAction() {
		setToolTipText("Open ontology");
		this.setText("Open ontology...");
	}
