...
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLClassChange.DisjointClassChange.AddDisjointClass;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLClassChange.DisjointClassChange.RemoveDisjointClass;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLClassChange.DisjointUnionChange.AddDisjointUnion;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLClassChange.DisjointUnionChange.RemoveDisjointUnion;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLClassChange.EquivalentClassChange.AddEquivalentClass;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLClassChange.EquivalentClassChange.RemoveEquivalentClass;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLDataPropertyChange.DataPropertyDomainChange.AddDataPropertyDomain;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLDataPropertyChange.DataPropertyDomainChange.RemoveDataPropertyDomain;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLDataPropertyChange.DataPropertyRangeChange.AddDataPropertyRange;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLDataPropertyChange.DataPropertyRangeChange.RemoveDataPropertyRange;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLDataPropertyChange.DisjointDataPropertyChange.AddDisjointDataProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLDataPropertyChange.DisjointDataPropertyChange.RemoveDisjointDataProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLDataPropertyChange.EquivalentDataPropertyChange.AddEquivalentDataProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLDataPropertyChange.EquivalentDataPropertyChange.RemoveEquivalentDataProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLDataPropertyChange.FunctionalDataPropertyChange.AddFunctionalDataProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLDataPropertyChange.FunctionalDataPropertyChange.RemoveFunctionalDataProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLDataPropertyChange.SubDataPropertyOfChange.AddSubDataPropertyOf;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLDataPropertyChange.SubDataPropertyOfChange.RemoveSubDataPropertyOf;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLIndividualChange.DifferentIndividualChange.AddDifferentIndividual;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLIndividualChange.DifferentIndividualChange.RemoveDifferentIndividual;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLIndividualChange.IndividualDataPropertyChange.AddIndividualDataProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLIndividualChange.IndividualDataPropertyChange.RemoveIndividualDataProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLIndividualChange.IndividualObjectPropertyChange.AddInvidivualObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLIndividualChange.IndividualObjectPropertyChange.RemoveInvidualObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLIndividualChange.SameIndividualChange.AddSameIndividual;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLIndividualChange.SameIndividualChange.RemoveSameIndividual;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.AsymmetricObjectPropertyChange.AddAsymmetricObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.AsymmetricObjectPropertyChange.RemoveAsymmetricObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.DisjointObjectPropertyChange.AddDisjointObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.DisjointObjectPropertyChange.RemoveDisjointObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.EquivalentObjectPropertyChange.AddEquivalentObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.EquivalentObjectPropertyChange.RemoveEquivalentObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.FunctionalObjectPropertyChange.AddFunctionalObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.FunctionalObjectPropertyChange.RemoveFunctionalObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.InverseFunctionalObjectPropertyChange.AddInverseFunctionalObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.InverseFunctionalObjectPropertyChange.RemoveInverseFunctionalObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.InverseObjectPropertyChange.AddInverseObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.InverseObjectPropertyChange.RemoveInverseObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.IrreflexiveObjectPropertyChange.AddIrreflexiveObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.IrreflexiveObjectPropertyChange.RemoveIrreflexiveObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.ObjectPropertyDomainChange.AddObjectPropertyDomain;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.ObjectPropertyDomainChange.RemoveObjectPropertyDomain;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.ObjectPropertyRangeChange.AddObjectPropertyRange;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.ObjectPropertyRangeChange.RemoveObjectPropertyRange;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.ReflexiveObjectPropertyChange.AddReflexiveObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.ReflexiveObjectPropertyChange.RemoveReflexiveObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.SubObjectPropertyOfChange.AddSubObjectPropertyOf;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.SubObjectPropertyOfChange.RemoveSubObjectPropertyOf;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.SymmetricObjectPropertyChange.AddSymmetricObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.SymmetricObjectPropertyChange.RemoveSymmetricObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.TransitiveObjectPropertyChange.AddTransitiveObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLObjectPropertyChange.TransitiveObjectPropertyChange.RemoveTransitiveObjectProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLOntologyChange.AddDataProperty;
...
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLOntologyChange.RemoveDataProperty;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLOntologyChange.RemoveDatatype;
import org.neon_toolkit.omv.api.extensions.OWLchange.OMVOWLChange.OMVOWLEntityChange.OWLOntologyChange.RemoveObjectProperty;
...
import org.neon_toolkit.omv.api.extensions.change.OMVChange.OMVCompositeChange.AddSubtree;
import org.neon_toolkit.omv.api.extensions.change.OMVChange.OMVCompositeChange.MergeSiblings;
import org.neon_toolkit.omv.api.extensions.change.OMVChange.OMVCompositeChange.MoveClass;
import org.neon_toolkit.omv.api.extensions.change.OMVChange.OMVCompositeChange.MoveSubtree;
import org.neon_toolkit.omv.api.extensions.change.OMVChange.OMVCompositeChange.RemoveSubtree;
import org.neon_toolkit.omv.api.extensions.change.OMVChange.OMVCompositeChange.SplitClass;
import org.neon_toolkit.omv.api.extensions.change.OMVChange.OMVCompositeChange.MoveSiblings.MoveSiblingsDown;
import org.neon_toolkit.omv.api.extensions.change.OMVChange.OMVCompositeChange.MoveSiblings.MoveSiblingsUp;
import org.neon_toolkit.omv.api.extensions.change.OMVChange.OMVEntityChange.AnnotationPropertyChange.CommentChange.AddComment;
import org.neon_toolkit.omv.api.extensions.change.OMVChange.OMVEntityChange.AnnotationPropertyChange.CommentChange.RemoveComment;
import org.neon_toolkit.omv.api.extensions.change.OMVChange.OMVEntityChange.AnnotationPropertyChange.LabelChange.AddLabel;
import org.neon_toolkit.omv.api.extensions.change.OMVChange.OMVEntityChange.AnnotationPropertyChange.LabelChange.RemoveLabel;
