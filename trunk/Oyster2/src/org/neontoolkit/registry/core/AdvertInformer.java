...
public class AdvertInformer{
    ...
    public synchronized Map getPeerSet(Ontology regOntology){
    	...
    	try{
    		...
    		for(Individual indiv: peerSet){
    			String guid = org.neontoolkit.registry.util.Utilities.getString(indiv.getDataPropertyValue(regOntology,GUID)); //OLD VERSION (String)
    			if(guid ==null) {
    ...
    public String getPeerIP(Ontology regOntology,Individual peerIndiv){
    	...
    	String IP = "";
    	try{
        	IP = org.neontoolkit.registry.util.Utilities.getString(peerIndiv.getDataPropertyValue(regOntology,IPAddress)); //NEW VALIDATION
        	}catch(Exception e){
        		e.printStackTrace();
        	}
    	return IP;
    ...
    public synchronized Map getRendezVousPeers(Ontology regOntology){
    	...
    	while(peerGuids.hasNext()){
    		...
    		try{
    			String type = org.neontoolkit.registry.util.Utilities.getString(peerIndiv.getDataPropertyValue(regOntology,peerType)); //(String)
    			if(type.equals("R")){//&&(!guid.equals(localUID))){
    				String IP = org.neontoolkit.registry.util.Utilities.getString(peerIndiv.getDataPropertyValue(regOntology,IPAdress)); //(String)
    ...
    public synchronized Individual getLocalPeer(){
    	...
    	while(peerIndivs.hasNext()){
    		...
    		try{
    			local = getBoolean(org.neontoolkit.registry.util.Utilities.getString(peerIndiv.getDataPropertyValue(regOntology,localPeer))); //(Boolean)
    		if(local){
    			break;
    		}
    		}catch(Exception e){
    ...
    public String getLocalUID(){
    	...
    	try{
    		if(peerIndiv!=null){
    			UID = org.neontoolkit.registry.util.Utilities.getString(peerIndiv.getDataPropertyValue(regOntology,GUID)); //(String)
    ...
    public String getMappingIP(Ontology regOntology,Individual mappingIndiv){
    	...
    	mappingIP = org.neontoolkit.registry.util.Utilities.getString(peerIndiv.getDataPropertyValue(regOntology,IPAddress)); //NEW VALIDATION
    	}catch(KAON2Exception e){
    		e.printStackTrace();
    	}
    	return mappingIP;
    ...
    public String getMappingURI(Ontology regOntology,Individual mappingIndiv){
    	...
    	String mappingURI = "";
    	try{
    		mappingURI = org.neontoolkit.registry.util.Utilities.getString(mappingIndiv.getDataPropertyValue(regOntology,ontologyURL));
    	}catch(KAON2Exception e){
    		e.printStackTrace();
    	}
    	return mappingURI;
    ...
    public synchronized void addExpertisePeer(Ontology remoteOntologyRegistry,Individual newPeer,Ontology targetOntology){
    	...
    	DataProperty GUID = KAON2Manager.factory().dataProperty(pdURI + "#GUID");
    	try{
    		String uid = org.neontoolkit.registry.util.Utilities.getString(newPeer.getDataPropertyValue(remoteOntologyRegistry,GUID));  //(String)
    		String olduid = org.neontoolkit.registry.util.Utilities.getString(newPeer.getDataPropertyValue(targetOntology,GUID)); //(String)
    		OWLClass Peer = KAON2Manager.factory().owlClass(pdURI+"#Peer");
    ...
    public synchronized void updateIPAddress(Ontology remoteOntologyRegistry,Individual peerIndiv,Ontology targetOntology){
    	...
    	String newGUID ="";
    	try{
    		oldIPStr = org.neontoolkit.registry.util.Utilities.getString(peerIndiv.getDataPropertyValue(targetOntology,IPAdress)); //(String)
    		newIPStr = org.neontoolkit.registry.util.Utilities.getString(peerIndiv.getDataPropertyValue(remoteOntologyRegistry,IPAdress)); //(String)
    		oldGUID = org.neontoolkit.registry.util.Utilities.getString(peerIndiv.getDataPropertyValue(targetOntology,GUID)); //(String)
    		newGUID = org.neontoolkit.registry.util.Utilities.getString(peerIndiv.getDataPropertyValue(remoteOntologyRegistry,GUID)); //(String)
    ...
    public synchronized void updatePeerAttributes(Ontology remoteOntologyRegistry,Individual peerIndiv,Ontology targetOntology){
    	...
    	try{
    		...
    		String type = org.neontoolkit.registry.util.Utilities.getString(peerIndiv.getDataPropertyValue(remoteOntologyRegistry,peerType)); //(String)
    ...
    public synchronized void updateDomainAttributes(Ontology remoteOntologyRegistry,Individual domainIndiv,Ontology targetOntology){
    	...
    	String oldURI = org.neontoolkit.registry.util.Utilities.getString(domainIndiv.getDataPropertyValue(targetOntology,mappingURI)); //(String)
    	String newURI = org.neontoolkit.registry.util.Utilities.getString(domainIndiv.getDataPropertyValue(remoteOntologyRegistry,mappingURI)); //(String)
    ...
    public synchronized void updateMappingAttributes(Ontology remoteOntologyRegistry,Individual mappingIndiv,Ontology targetOntology){
    	...
    	String oldURI = org.neontoolkit.registry.util.Utilities.getString(mappingIndiv.getDataPropertyValue(targetOntology,mappingURI)); //(String)
    	String newURI = org.neontoolkit.registry.util.Utilities.getString(mappingIndiv.getDataPropertyValue(remoteOntologyRegistry,mappingURI)); //(String)
    ...
    public synchronized void updateOntologyAttributes(Ontology remoteOntologyRegistry,Individual ontologyIndiv,Ontology targetOntology){
    	...
    	String oldName = org.neontoolkit.registry.util.Utilities.getString(ontologyIndiv.getDataPropertyValue(targetOntology,ontologyName)); //(String)
    	String newName = org.neontoolkit.registry.util.Utilities.getString(ontologyIndiv.getDataPropertyValue(remoteOntologyRegistry,ontologyName)); //(String)
    	String oldURI = org.neontoolkit.registry.util.Utilities.getString(ontologyIndiv.getDataPropertyValue(targetOntology,ontologyURI)); //(String)
    	String newURI = org.neontoolkit.registry.util.Utilities.getString(ontologyIndiv.getDataPropertyValue(remoteOntologyRegistry,ontologyURI)); //(String)
    	String oldResourceLocator = org.neontoolkit.registry.util.Utilities.getString(ontologyIndiv.getDataPropertyValue(targetOntology,ontologyResourceLocator)); //(String)
    	String newResourceLocator = org.neontoolkit.registry.util.Utilities.getString(ontologyIndiv.getDataPropertyValue(remoteOntologyRegistry,ontologyResourceLocator)); //(String)
    	String oldVersion = org.neontoolkit.registry.util.Utilities.getString(ontologyIndiv.getDataPropertyValue(targetOntology,ontologyVersion)); //(String)
    	String newVersion = org.neontoolkit.registry.util.Utilities.getString(ontologyIndiv.getDataPropertyValue(remoteOntologyRegistry,ontologyVersion)); //(String)
    ...
    public synchronized void addMappingOntology(Ontology remoteOntologyRegistry,Individual mapping,Ontology localOntologyRegistry){
    	...
    	String url = org.neontoolkit.registry.util.Utilities.getString(mapping.getDataPropertyValue(remoteOntologyRegistry,ontologyURL)); //(String)
    ...
    public synchronized void informerIP(Ontology remoteOntology,Ontology localOntology, String rendezvouzPeerIP){
	  try{
		  ...
		  localOldIP = org.neontoolkit.registry.util.Utilities.getString(getLocalPeer().getDataPropertyValue(localOntology,IPAdress)); //(String)
  ...
  public synchronized void updateLocalIP(){
	  ...
	  //UPDATE LOCAL IP ADDRESS IN PEER INDIVIDUAL
	  try {
		localOldIP = org.neontoolkit.registry.util.Utilities.getString(getLocalPeer().getDataPropertyValue(localOntology,IPAdress));
		if (localOldIP==null || !localOldIP.equals(newIP)){
			  //System.out.println("localOldIP: "+localOldIP +" newIP: "+newIP);
			  List<OntologyChangeEvent> changes2=new ArrayList<OntologyChangeEvent>();
			  changes2.add(new OntologyChangeEvent(KAON2Manager.factory().dataPropertyMember(IPAdress,peerIndiv,KAON2Manager.factory().constant(localOldIP)),OntologyChangeEvent.ChangeType.REMOVE));
