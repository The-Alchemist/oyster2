    	 ...
    	 if (!onProcess.contains(OWLEntityIndividual)){
    		 ...
    		 try{
    			 ...
    			 if ((dataPropertyMap.size()+objectPropertyMap.size())>0){
    				 ...
    				 if (whichClass.equalsIgnoreCase("DataProperty")) reply = new org.neon_toolkit.owlodm.api.OWLEntity.DataProperty(OWLEntityIndividual.getURI());
    				 else if (whichClass.equalsIgnoreCase("Datatype")) reply = new Datatype(OWLEntityIndividual.getURI());
    				 else if (whichClass.equalsIgnoreCase("Individual")) reply = new org.neon_toolkit.owlodm.api.OWLEntity.Individual(OWLEntityIndividual.getURI());
    				 else if (whichClass.equalsIgnoreCase("ObjectProperty")) reply = new org.neon_toolkit.owlodm.api.OWLEntity.ObjectProperty(OWLEntityIndividual.getURI());			
    		 ...
    		 if (reply instanceof org.neon_toolkit.owlodm.api.OWLEntity.DataProperty || reply instanceof Datatype || reply instanceof org.neon_toolkit.owlodm.api.OWLEntity.Individual || reply instanceof org.neon_toolkit.owlodm.api.OWLEntity.ObjectProperty )
    			 return reply;
    		 else return null; 
    	 }
    	 else{
