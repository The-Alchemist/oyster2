...
public class OntologyEngineeringToolSubmit extends OMVRegistryObjectSubmit {
	public static Object submit(OntologyEngineeringToolType input, Object outputIn){
		
		OMVOntologyEngineeringTool output;
		if (outputIn==null) output = new OMVOntologyEngineeringTool();
		else output = ((OMVOntologyEngineeringTool)outputIn);
