...
/**
 *  OntologyDomainQueryType bean class
 */
public class OntologyDomainQueryType extends org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType
    ...
    /**
     * field for IsSubDomainOfQuery
     * This was an Array!
     */
    protected org.neon_toolkit.registry.omv.xsd.query.OntologyDomainQueryType[] localIsSubDomainOfQuery;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localIsSubDomainOfQueryTracker = false;

    /* This type was generated from the piece of schema that had
       name = OntologyDomainQueryType
     ...
     */
    public org.neon_toolkit.registry.omv.xsd.query.OntologyDomainQueryType[] getIsSubDomainOfQuery() {
        return localIsSubDomainOfQuery;
    }

    /**
     * validate the array for IsSubDomainOfQuery
     */
    protected void validateIsSubDomainOfQuery(
        org.neon_toolkit.registry.omv.xsd.query.OntologyDomainQueryType[] param) {
    }

    /**
     * Auto generated setter method
     * @param param IsSubDomainOfQuery
     */
    public void setIsSubDomainOfQuery(
        org.neon_toolkit.registry.omv.xsd.query.OntologyDomainQueryType[] param) {
        validateIsSubDomainOfQuery(param);

        if (param != null) {
            //update the setting tracker
            localIsSubDomainOfQueryTracker = true;
        } else {
            localIsSubDomainOfQueryTracker = false;
        }

        this.localIsSubDomainOfQuery = param;
    }
     ...
     */
    public void addIsSubDomainOfQuery(
        org.neon_toolkit.registry.omv.xsd.query.OntologyDomainQueryType param) {
        if (localIsSubDomainOfQuery == null) {
            localIsSubDomainOfQuery = new org.neon_toolkit.registry.omv.xsd.query.OntologyDomainQueryType[] {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localIsSubDomainOfQuery);
        list.add(param);
        this.localIsSubDomainOfQuery = (org.neon_toolkit.registry.omv.xsd.query.OntologyDomainQueryType[]) list.toArray(new org.neon_toolkit.registry.omv.xsd.query.OntologyDomainQueryType[list.size()]);
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    OntologyDomainQueryType.this.serialize(parentQName,
                        factory, xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":OntologyDomainQueryType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "OntologyDomainQueryType", xmlWriter);
        }
        ...
        if (localIsSubDomainOfQueryTracker) {
            if (localIsSubDomainOfQuery != null) {
                for (int i = 0; i < localIsSubDomainOfQuery.length; i++) {
                    if (localIsSubDomainOfQuery[i] != null) {
                        localIsSubDomainOfQuery[i].serialize(new javax.xml.namespace.QName(
                                "urn:neon-toolkit-org:registry:omv:xsd:query:2.3",
                                "IsSubDomainOfQuery"), factory, xmlWriter);
                    } else {
                        // we don't have to do any thing since minOccures is zero
                    }
                }
                ...
                throw new org.apache.axis2.databinding.ADBException(
                    "IsSubDomainOfQuery cannot be null!!");
            }
        }
                ...
                for (int i = 0; i < localIsSubDomainOfQuery.length; i++) {
                    if (localIsSubDomainOfQuery[i] != null) {
                        elementList.add(new javax.xml.namespace.QName(
                                "urn:neon-toolkit-org:registry:omv:xsd:query:2.3",
                                "IsSubDomainOfQuery"));
                        elementList.add(localIsSubDomainOfQuery[i]);
                    } else {
                        // nothing to do
                    }
                }
    ...
    public static class Factory {
         ...
         */
        public static OntologyDomainQueryType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            OntologyDomainQueryType object = new OntologyDomainQueryType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"OntologyDomainQueryType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (OntologyDomainQueryType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:neon-toolkit-org:registry:omv:xsd:query:2.3",
                            "IsSubDomainOfQuery").equals(reader.getName())) {
                    // Process the array and step past its final element's end.
                    list13.add(org.neon_toolkit.registry.omv.xsd.query.OntologyDomainQueryType.Factory.parse(
                            reader));
                    ...
                    // call the converter utility  to convert and set the array
                    object.setIsSubDomainOfQuery((org.neon_toolkit.registry.omv.xsd.query.OntologyDomainQueryType[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
