...
/**
 *  ExtrinsicObjectQueryType bean class
 */
public class ExtrinsicObjectQueryType extends org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for ContentVersionInfoFilter
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.query.FilterType localContentVersionInfoFilter;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localContentVersionInfoFilterTracker = false;
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.query.FilterType getContentVersionInfoFilter() {
        return localContentVersionInfoFilter;
    }

    /**
     * Auto generated setter method
     * @param param ContentVersionInfoFilter
     */
    public void setContentVersionInfoFilter(
        org.oasis.names.tc.ebxml_regrep.xsd.query.FilterType param) {
        if (param != null) {
            //update the setting tracker
            localContentVersionInfoFilterTracker = true;
        } else {
            localContentVersionInfoFilterTracker = false;
        }

        this.localContentVersionInfoFilter = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    ExtrinsicObjectQueryType.this.serialize(parentQName,
                        factory, xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":ExtrinsicObjectQueryType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "ExtrinsicObjectQueryType", xmlWriter);
        }
        ...
        if (localContentVersionInfoFilterTracker) {
            if (localContentVersionInfoFilter == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "ContentVersionInfoFilter cannot be null!!");
            }

            localContentVersionInfoFilter.serialize(new javax.xml.namespace.QName(
                    "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                    "ContentVersionInfoFilter"), factory, xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localContentVersionInfoFilterTracker) {
            ...
            elementList.add(localContentVersionInfoFilter);
        }
    ...
    public static class Factory {
         ...
         */
        public static ExtrinsicObjectQueryType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ExtrinsicObjectQueryType object = new ExtrinsicObjectQueryType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ExtrinsicObjectQueryType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ExtrinsicObjectQueryType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                            "ContentVersionInfoFilter").equals(reader.getName())) {
                    object.setContentVersionInfoFilter(org.oasis.names.tc.ebxml_regrep.xsd.query.FilterType.Factory.parse(
                            reader));
