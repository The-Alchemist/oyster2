...
/**
 *  ServiceBindingType bean class
 */
public class ServiceBindingType extends org.oasis.names.tc.ebxml_regrep.xsd.rim.RegistryObjectType
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for SpecificationLink
     * This was an Array!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.SpecificationLinkType[] localSpecificationLink;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localSpecificationLinkTracker = false;

    /**
     * field for Service
     * This was an Attribute!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI localService;

    /**
     * field for AccessURI
     * This was an Attribute!
     */
    protected org.apache.axis2.databinding.types.URI localAccessURI;

    /**
     * field for TargetBinding
     * This was an Attribute!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI localTargetBinding;
     ...
     * @return org.oasis.names.tc.ebxml_regrep.xsd.rim.SpecificationLinkType[]
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.SpecificationLinkType[] getSpecificationLink() {
        return localSpecificationLink;
    }

    /**
     * validate the array for SpecificationLink
     */
    protected void validateSpecificationLink(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.SpecificationLinkType[] param) {
    }

    /**
     * Auto generated setter method
     * @param param SpecificationLink
     */
    public void setSpecificationLink(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.SpecificationLinkType[] param) {
        validateSpecificationLink(param);

        if (param != null) {
            //update the setting tracker
            localSpecificationLinkTracker = true;
        } else {
            localSpecificationLinkTracker = false;
        }

        this.localSpecificationLink = param;
    }

    /**
     * Auto generated add method for the array for convenience
     * @param param org.oasis.names.tc.ebxml_regrep.xsd.rim.SpecificationLinkType
     */
    public void addSpecificationLink(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.SpecificationLinkType param) {
        if (localSpecificationLink == null) {
            localSpecificationLink = new org.oasis.names.tc.ebxml_regrep.xsd.rim.SpecificationLinkType[] {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localSpecificationLink);
        list.add(param);
        this.localSpecificationLink = (org.oasis.names.tc.ebxml_regrep.xsd.rim.SpecificationLinkType[]) list.toArray(new org.oasis.names.tc.ebxml_regrep.xsd.rim.SpecificationLinkType[list.size()]);
    }
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI getService() {
        return localService;
    }
     ...
     */
    public org.apache.axis2.databinding.types.URI getAccessURI() {
        return localAccessURI;
    }

    /**
     * Auto generated setter method
     * @param param AccessURI
     */
    public void setAccessURI(org.apache.axis2.databinding.types.URI param) {
        this.localAccessURI = param;
    }
     ...
     * @return org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI getTargetBinding() {
        return localTargetBinding;
    }

    /**
     * Auto generated setter method
     * @param param TargetBinding
     */
    public void setTargetBinding(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI param) {
        this.localTargetBinding = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    ServiceBindingType.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":ServiceBindingType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "ServiceBindingType", xmlWriter);
        }
        ...
        if (localService != null) {
            writeAttribute("", "service", localService.toString(), xmlWriter);
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "required attribute localService is null");
        }

        if (localAccessURI != null) {
            writeAttribute("", "accessURI",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localAccessURI), xmlWriter);
        }

        if (localTargetBinding != null) {
            writeAttribute("", "targetBinding", localTargetBinding.toString(),
                xmlWriter);
        }
        ...
        if (localSpecificationLinkTracker) {
            if (localSpecificationLink != null) {
                for (int i = 0; i < localSpecificationLink.length; i++) {
                    if (localSpecificationLink[i] != null) {
                        localSpecificationLink[i].serialize(new javax.xml.namespace.QName(
                                "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0",
                                "SpecificationLink"), factory, xmlWriter);
                    } else {
                        // we don't have to do any thing since minOccures is zero
                    }
                }
                ...
                throw new org.apache.axis2.databinding.ADBException(
                    "SpecificationLink cannot be null!!");
            }
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
                ...
                for (int i = 0; i < localSpecificationLink.length; i++) {
                    if (localSpecificationLink[i] != null) {
                        elementList.add(new javax.xml.namespace.QName(
                                "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0",
                                "SpecificationLink"));
                        elementList.add(localSpecificationLink[i]);
                    } else {
                        // nothing to do
                    }
                }
        ...
        attribList.add(new javax.xml.namespace.QName("", "service"));

        attribList.add(localService.toString());

        attribList.add(new javax.xml.namespace.QName("", "accessURI"));

        attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                localAccessURI));

        attribList.add(new javax.xml.namespace.QName("", "targetBinding"));

        attribList.add(localTargetBinding.toString());
    ...
    public static class Factory {
         ...
         */
        public static ServiceBindingType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ServiceBindingType object = new ServiceBindingType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ServiceBindingType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ServiceBindingType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribService = reader.getAttributeValue(null,
                        "service");

                if (tempAttribService != null) {
                    java.lang.String content = tempAttribService;

                    if (tempAttribService.indexOf(":") > 0) {
                        // this seems to be a Qname so find the namespace and send
                        prefix = tempAttribService.substring(0,
                                tempAttribService.indexOf(":"));
                        namespaceuri = reader.getNamespaceURI(prefix);
                        object.setService(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribService, namespaceuri));
                    } else {
                        // this seems to be not a qname send and empty namespace incase of it is
                        // check is done in fromString method
                        object.setService(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                    ...
                    throw new org.apache.axis2.databinding.ADBException(
                        "Required attribute service is missing");
                }

                handledAttributes.add("service");

                // handle attribute "accessURI"
                java.lang.String tempAttribAccessURI = reader.getAttributeValue(null,
                        "accessURI");

                if (tempAttribAccessURI != null) {
                    java.lang.String content = tempAttribAccessURI;

                    object.setAccessURI(org.apache.axis2.databinding.utils.ConverterUtil.convertToAnyURI(
                            tempAttribAccessURI));
                } else {
                }

                handledAttributes.add("accessURI");

                // handle attribute "targetBinding"
                java.lang.String tempAttribTargetBinding = reader.getAttributeValue(null,
                        "targetBinding");

                if (tempAttribTargetBinding != null) {
                    java.lang.String content = tempAttribTargetBinding;

                    if (tempAttribTargetBinding.indexOf(":") > 0) {
                        // this seems to be a Qname so find the namespace and send
                        prefix = tempAttribTargetBinding.substring(0,
                                tempAttribTargetBinding.indexOf(":"));
                        namespaceuri = reader.getNamespaceURI(prefix);
                        object.setTargetBinding(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribTargetBinding, namespaceuri));
                    } else {
                        // this seems to be not a qname send and empty namespace incase of it is
                        // check is done in fromString method
                        object.setTargetBinding(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribTargetBinding, ""));
                    }
                } else {
                }

                handledAttributes.add("targetBinding");
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0",
                            "SpecificationLink").equals(reader.getName())) {
                    // Process the array and step past its final element's end.
                    list7.add(org.oasis.names.tc.ebxml_regrep.xsd.rim.SpecificationLinkType.Factory.parse(
                            reader));
                    ...
                    // call the converter utility  to convert and set the array
                    object.setSpecificationLink((org.oasis.names.tc.ebxml_regrep.xsd.rim.SpecificationLinkType[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            org.oasis.names.tc.ebxml_regrep.xsd.rim.SpecificationLinkType.class,
                            list7));
                } // End of if for expected property start element
