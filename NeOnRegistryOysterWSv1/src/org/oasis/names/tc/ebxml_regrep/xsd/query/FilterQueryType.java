...
/**
 *  FilterQueryType bean class
 */
public abstract class FilterQueryType implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for PrimaryFilter
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.query.FilterType localPrimaryFilter;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localPrimaryFilterTracker = false;
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.query.FilterType getPrimaryFilter() {
        return localPrimaryFilter;
    }

    /**
     * Auto generated setter method
     * @param param PrimaryFilter
     */
    public void setPrimaryFilter(
        org.oasis.names.tc.ebxml_regrep.xsd.query.FilterType param) {
        if (param != null) {
            //update the setting tracker
            localPrimaryFilterTracker = true;
        } else {
            localPrimaryFilterTracker = false;
        }

        this.localPrimaryFilter = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    FilterQueryType.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public static class Factory {
         ...
         */
        public static FilterQueryType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            FilterQueryType object = null;
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"FilterQueryType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (FilterQueryType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
