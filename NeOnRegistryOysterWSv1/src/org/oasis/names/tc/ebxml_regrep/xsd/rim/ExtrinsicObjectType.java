...
/**
 *  ExtrinsicObjectType bean class
 */
public class ExtrinsicObjectType extends org.oasis.names.tc.ebxml_regrep.xsd.rim.RegistryObjectType
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for ContentVersionInfo
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.VersionInfoType localContentVersionInfo;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localContentVersionInfoTracker = false;

    /**
     * field for MimeType
     * This was an Attribute!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.LongName localMimeType;

    /**
     * field for IsOpaque
     * This was an Attribute!
     */
    protected boolean localIsOpaque;
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.VersionInfoType getContentVersionInfo() {
        return localContentVersionInfo;
    }

    /**
     * Auto generated setter method
     * @param param ContentVersionInfo
     */
    public void setContentVersionInfo(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.VersionInfoType param) {
        if (param != null) {
            //update the setting tracker
            localContentVersionInfoTracker = true;
        } else {
            localContentVersionInfoTracker = false;
        }

        this.localContentVersionInfo = param;
    }
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.LongName getMimeType() {
    ...
    public boolean getIsOpaque() {
        return localIsOpaque;
    }

    /**
     * Auto generated setter method
     * @param param IsOpaque
     */
    public void setIsOpaque(boolean param) {
        this.localIsOpaque = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    ExtrinsicObjectType.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":ExtrinsicObjectType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "ExtrinsicObjectType", xmlWriter);
        }
        ...
        if (localMimeType != null) {
            writeAttribute("", "mimeType", localMimeType.toString(), xmlWriter);
        }

        if (true) {
            writeAttribute("", "isOpaque",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localIsOpaque), xmlWriter);
        }
        ...
        if (localContentVersionInfoTracker) {
            if (localContentVersionInfo == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "ContentVersionInfo cannot be null!!");
            }

            localContentVersionInfo.serialize(new javax.xml.namespace.QName(
                    "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0",
                    "ContentVersionInfo"), factory, xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localContentVersionInfoTracker) {
            ...
            elementList.add(localContentVersionInfo);
        }
        ...
        attribList.add(localMimeType.toString());

        attribList.add(new javax.xml.namespace.QName("", "isOpaque"));
    ...
    public static class Factory {
         ...
         */
        public static ExtrinsicObjectType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ExtrinsicObjectType object = new ExtrinsicObjectType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ExtrinsicObjectType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ExtrinsicObjectType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (tempAttribMimeType != null) {
                    ...
                    if (tempAttribMimeType.indexOf(":") > 0) {
                        // this seems to be a Qname so find the namespace and send
                        prefix = tempAttribMimeType.substring(0,
                                tempAttribMimeType.indexOf(":"));
                        namespaceuri = reader.getNamespaceURI(prefix);
                        object.setMimeType(org.oasis.names.tc.ebxml_regrep.xsd.rim.LongName.Factory.fromString(
                                tempAttribMimeType, namespaceuri));
                    } else {
                        // this seems to be not a qname send and empty namespace incase of it is
                        // check is done in fromString method
                        object.setMimeType(org.oasis.names.tc.ebxml_regrep.xsd.rim.LongName.Factory.fromString(
                ...
                // handle attribute "isOpaque"
                java.lang.String tempAttribIsOpaque = reader.getAttributeValue(null,
                        "isOpaque");

                if (tempAttribIsOpaque != null) {
                    java.lang.String content = tempAttribIsOpaque;

                    object.setIsOpaque(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
                            tempAttribIsOpaque));
                } else {
                }

                handledAttributes.add("isOpaque");
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0",
                            "ContentVersionInfo").equals(reader.getName())) {
                    object.setContentVersionInfo(org.oasis.names.tc.ebxml_regrep.xsd.rim.VersionInfoType.Factory.parse(
                            reader));
