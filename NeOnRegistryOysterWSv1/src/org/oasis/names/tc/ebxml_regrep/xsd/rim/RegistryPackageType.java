...
/**
 *  RegistryPackageType bean class
 */
public class RegistryPackageType extends org.oasis.names.tc.ebxml_regrep.xsd.rim.RegistryObjectType
     ...
     */
    protected boolean localRegistryObjectListTracker = false;
    ...
    public void setRegistryObjectList(
        ...
        if (param != null) {
            ...
            localRegistryObjectListTracker = true;
        } else {
            localRegistryObjectListTracker = false;
        }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    RegistryPackageType.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":RegistryPackageType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "RegistryPackageType", xmlWriter);
        }
        ...
        if (localRegistryObjectListTracker) {
    ...
    public static class Factory {
         ...
         */
        public static RegistryPackageType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RegistryPackageType object = new RegistryPackageType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RegistryPackageType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RegistryPackageType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
