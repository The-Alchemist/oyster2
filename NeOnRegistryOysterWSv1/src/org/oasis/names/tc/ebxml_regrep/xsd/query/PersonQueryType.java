...
/**
 *  PersonQueryType bean class
 */
public class PersonQueryType extends org.oasis.names.tc.ebxml_regrep.xsd.query.RegistryObjectQueryType
    ...
    /**
     * field for PersonNameFilter
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.query.FilterType localPersonNameFilter;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localPersonNameFilterTracker = false;
     ...
     * @return org.oasis.names.tc.ebxml_regrep.xsd.query.FilterType
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.query.FilterType getPersonNameFilter() {
        return localPersonNameFilter;
    }

    /**
     * Auto generated setter method
     * @param param PersonNameFilter
     */
    public void setPersonNameFilter(
        org.oasis.names.tc.ebxml_regrep.xsd.query.FilterType param) {
        if (param != null) {
            //update the setting tracker
            localPersonNameFilterTracker = true;
        } else {
            localPersonNameFilterTracker = false;
        }

        this.localPersonNameFilter = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    PersonQueryType.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":PersonQueryType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "PersonQueryType", xmlWriter);
        }
        ...
        if (localPersonNameFilterTracker) {
            if (localPersonNameFilter == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "PersonNameFilter cannot be null!!");
            }

            localPersonNameFilter.serialize(new javax.xml.namespace.QName(
                    "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                    "PersonNameFilter"), factory, xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localPersonNameFilterTracker) {
            ...
            elementList.add(localPersonNameFilter);
        }
    ...
    public static class Factory {
         ...
         */
        public static PersonQueryType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            PersonQueryType object = new PersonQueryType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"PersonQueryType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (PersonQueryType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0",
                            "PersonNameFilter").equals(reader.getName())) {
                    object.setPersonNameFilter(org.oasis.names.tc.ebxml_regrep.xsd.query.FilterType.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                    ...
                    // Process the array and step past its final element's end.
                    list15.add(org.oasis.names.tc.ebxml_regrep.xsd.query.FilterType.Factory.parse(
                            reader));
