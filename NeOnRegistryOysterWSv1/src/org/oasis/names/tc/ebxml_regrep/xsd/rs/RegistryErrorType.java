...
/**
 *  RegistryErrorType bean class
 */
public class RegistryErrorType implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for String
     */
     ...
     */
    protected java.lang.String localCodeContext;
     ...
     * This was an Attribute!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI localSeverity;
     ...
     */
    public void setCodeContext(java.lang.String param) {
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI getSeverity() {
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    RegistryErrorType.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localCodeContext != null) {
            writeAttribute("", "codeContext",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localCodeContext), xmlWriter);
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "required attribute localCodeContext is null");
        }
        ...
        if (localSeverity != null) {
            writeAttribute("", "severity", localSeverity.toString(), xmlWriter);
        }

        if (localLocation != null) {
            writeAttribute("", "location",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localLocation), xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        attribList.add(new javax.xml.namespace.QName("", "codeContext"));
    ...
    public static class Factory {
        public static RegistryErrorType fromString(java.lang.String value,
            java.lang.String namespaceURI) {
            RegistryErrorType returnValue = new RegistryErrorType();
         ...
         */
        public static RegistryErrorType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RegistryErrorType object = new RegistryErrorType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RegistryErrorType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RegistryErrorType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribCodeContext = reader.getAttributeValue(null,
                        "codeContext");

                if (tempAttribCodeContext != null) {
                    java.lang.String content = tempAttribCodeContext;

                    object.setCodeContext(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribCodeContext));
                } else {
                    throw new org.apache.axis2.databinding.ADBException(
                        "Required attribute codeContext is missing");
                }
                ...
                if (tempAttribSeverity != null) {
                    ...
                    if (tempAttribSeverity.indexOf(":") > 0) {
                        // this seems to be a Qname so find the namespace and send
                        prefix = tempAttribSeverity.substring(0,
                                tempAttribSeverity.indexOf(":"));
                        namespaceuri = reader.getNamespaceURI(prefix);
                        object.setSeverity(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribSeverity, namespaceuri));
                    } else {
                ...
                java.lang.String tempAttribLocation = reader.getAttributeValue(null,
                        "location");
