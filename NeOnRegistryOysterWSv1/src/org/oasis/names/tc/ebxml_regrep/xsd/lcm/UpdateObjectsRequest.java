...
/**
 *  UpdateObjectsRequest bean class
 */
public class UpdateObjectsRequest extends org.oasis.names.tc.ebxml_regrep.xsd.rs.RegistryRequestType
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    UpdateObjectsRequest.this.serialize(MY_QNAME, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":UpdateObjectsRequest", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "UpdateObjectsRequest", xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static UpdateObjectsRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UpdateObjectsRequest object = new UpdateObjectsRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"UpdateObjectsRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (UpdateObjectsRequest) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
