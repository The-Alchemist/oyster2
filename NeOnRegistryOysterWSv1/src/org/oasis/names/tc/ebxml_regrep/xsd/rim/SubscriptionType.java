...
/**
 *  SubscriptionType bean class
 */
public class SubscriptionType extends org.oasis.names.tc.ebxml_regrep.xsd.rim.RegistryObjectType
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for Action
     * This was an Array!
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ActionType[] localAction;
     ...
     */
    protected org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI localSelector;
    ...
    /**
     * field for NotificationInterval
     * This was an Attribute!
     */
    protected org.apache.axis2.databinding.types.Duration localNotificationInterval;
     ...
     * @return org.oasis.names.tc.ebxml_regrep.xsd.rim.ActionType[]
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ActionType[] getAction() {
        return localAction;
    }
    ...
    protected void validateAction(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.ActionType[] param) {
    }
     ...
     * @param param org.oasis.names.tc.ebxml_regrep.xsd.rim.ActionType
     */
    public void addAction(
        org.oasis.names.tc.ebxml_regrep.xsd.rim.ActionType param) {
        if (localAction == null) {
            localAction = new org.oasis.names.tc.ebxml_regrep.xsd.rim.ActionType[] {
        ...
        list.add(param);
        this.localAction = (org.oasis.names.tc.ebxml_regrep.xsd.rim.ActionType[]) list.toArray(new org.oasis.names.tc.ebxml_regrep.xsd.rim.ActionType[list.size()]);
    }
     ...
     */
    public org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI getSelector() {
     ...
     */
    public org.apache.axis2.databinding.types.Duration getNotificationInterval() {
        return localNotificationInterval;
    }

    /**
     * Auto generated setter method
     * @param param NotificationInterval
     */
    public void setNotificationInterval(
        org.apache.axis2.databinding.types.Duration param) {
        this.localNotificationInterval = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    SubscriptionType.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":SubscriptionType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "SubscriptionType", xmlWriter);
        }
        ...
        if (localSelector != null) {
            writeAttribute("", "selector", localSelector.toString(), xmlWriter);
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "required attribute localSelector is null");
        }

        if (localStartTime != null) {
            writeAttribute("", "startTime",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localStartTime), xmlWriter);
        }

        if (localEndTime != null) {
            writeAttribute("", "endTime",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localEndTime), xmlWriter);
        }

        if (localNotificationInterval != null) {
            writeAttribute("", "notificationInterval",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localNotificationInterval), xmlWriter);
        }
            ...
            if (localAction != null) {
                for (int i = 0; i < localAction.length; i++) {
                    if (localAction[i] != null) {
                        localAction[i].serialize(new javax.xml.namespace.QName(
                                "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0",
                                "Action"), factory, xmlWriter);
                    } else {
                        // we don't have to do any thing since minOccures is zero
                    }
                }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        attribList.add(new javax.xml.namespace.QName("", "selector"));

        attribList.add(localSelector.toString());
        ...
        attribList.add(new javax.xml.namespace.QName("", "endTime"));

        attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                localEndTime));

        attribList.add(new javax.xml.namespace.QName("", "notificationInterval"));
    ...
    public static class Factory {
         ...
         */
        public static SubscriptionType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SubscriptionType object = new SubscriptionType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SubscriptionType".equals(type)) {
                            ...
                            return (SubscriptionType) org.oasis.names.tc.ebxml_regrep.xsd.rs.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribSelector = reader.getAttributeValue(null,
                        "selector");

                if (tempAttribSelector != null) {
                    java.lang.String content = tempAttribSelector;

                    if (tempAttribSelector.indexOf(":") > 0) {
                        // this seems to be a Qname so find the namespace and send
                        prefix = tempAttribSelector.substring(0,
                                tempAttribSelector.indexOf(":"));
                        namespaceuri = reader.getNamespaceURI(prefix);
                        object.setSelector(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                                tempAttribSelector, namespaceuri));
                    } else {
                        // this seems to be not a qname send and empty namespace incase of it is
                        // check is done in fromString method
                        object.setSelector(org.oasis.names.tc.ebxml_regrep.xsd.rim.ReferenceURI.Factory.fromString(
                    ...
                    throw new org.apache.axis2.databinding.ADBException(
                        "Required attribute selector is missing");
                }

                handledAttributes.add("selector");

                // handle attribute "startTime"
                java.lang.String tempAttribStartTime = reader.getAttributeValue(null,
                        "startTime");
                ...
                java.lang.String tempAttribEndTime = reader.getAttributeValue(null,
                        "endTime");
                ...
                // handle attribute "notificationInterval"
                java.lang.String tempAttribNotificationInterval = reader.getAttributeValue(null,
                        "notificationInterval");

                if (tempAttribNotificationInterval != null) {
                    java.lang.String content = tempAttribNotificationInterval;

                    object.setNotificationInterval(org.apache.axis2.databinding.utils.ConverterUtil.convertToDuration(
                            tempAttribNotificationInterval));
                } else {
                }

                handledAttributes.add("notificationInterval");
                ...
                if (reader.isStartElement() &&
                    ...
                    // Process the array and step past its final element's end.
                    list7.add(org.oasis.names.tc.ebxml_regrep.xsd.rim.ActionType.Factory.parse(
                            reader));
                    ...
                    // call the converter utility  to convert and set the array
                    object.setAction((org.oasis.names.tc.ebxml_regrep.xsd.rim.ActionType[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            org.oasis.names.tc.ebxml_regrep.xsd.rim.ActionType.class,
                            list7));
                } // End of if for expected property start element
