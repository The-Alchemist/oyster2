...
public class XMLOyster2Host extends Oyster2Host implements XMLizable {
	 ...
	 * @param port    the port.
	 */
	protected XMLOyster2Host(org.neontoolkit.registry.util.GUID guid, InetAddress netAddr, int port) {
	 ...
	 * @return the host.
	 */
	public static XMLOyster2Host getHost(org.neontoolkit.registry.util.GUID guid) {
		if (guid == null)
	...
	public static XMLOyster2Host getHost(String addr) {
		...
		XMLOyster2Host host;
		if (guidPos > 0) {
			org.neontoolkit.registry.util.GUID guid = org.neontoolkit.registry.util.GUID.getGUID(addr.substring(0, guidPos));
	...
	public static XMLOyster2Host getHost(String guid, String addr, String port) {
		org.neontoolkit.registry.util.GUID g = org.neontoolkit.registry.util.GUID.getGUID(guid);
		XMLOyster2Host host = (XMLOyster2Host)mHosts.get(org.neontoolkit.registry.util.GUID.getGUID(guid));
		if (host == null) {
			try {
	 ...
	 * @return the created host.
	 */
	public static XMLOyster2Host getHost(org.neontoolkit.registry.util.GUID guid, InetAddress netAddr, int port) {
